...
| UI/HUD / frontend looks cheap / make the UI A-list / any menu, HUD or screen redesign | **`design/frontend/direction/FIELD_HARDWARE_PROGRAM.md`** (2026-09-10; frames under `design/frontend/direction/approved/` outrank prose) → `--id PQ-194`; hand-off packets `design/frontend/direction/packets/` → then `src/ui/AGENTS.md`, `styles/AGENTS.md` |
