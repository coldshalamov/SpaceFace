...
- .devshots/graphics-revamp/2026-07-05_greeble_nav_lights_clay.png — clay MCP after bevel+WN for nav lights greeble. Verifies emitter base form.
- .devshots/graphics-revamp/2026-07-05_greeble_nav_lights_lit.png — lit. Verifies accent emissive zones.
- .devshots/graphics-revamp/2026-07-05_greeble_nav_lights_close.png — close. Verifies bolt and light detail.
...
| skid_trio | gear | PRO | 1040 / 1040 | bevel (segs=2) + WN + AO via MCP | 3 (clay,lit,close) | PASS | 2026-07-05 | renders: 2026-07-05_skid_trio_*.png (3 distinct); def: assets/ships/parts/revamp-evidence/skid_trio/deficiency.md (26 specific); authored: blender/skid_trio_authored.blend; finalize.log match; character: robust landing legs with foot pads, industrial wear |
| skid_quad | gear | PRO | 1532 / 1532 | bevel (segs=2) + WN + AO via MCP | 3 (clay,lit,close) | PASS | 2026-07-05 | renders: 2026-07-05_skid_quad_*.png (3 distinct); def: assets/ships/parts/revamp-evidence/skid_quad/deficiency.md (26 specific); authored: blender/skid_quad_authored.blend; finalize.log match; character: 4-foot landing system, industrial wear |
| pod_utility | pods | PRO | 952 / 952 | bevel (segs=2) + WN + AO via MCP | 3 (clay,lit,close) | PASS | 2026-07-05 | renders: 2026-07-05_pod_utility_*.png (3 distinct); def: assets/ships/parts/revamp-evidence/pod_utility/deficiency.md (26 specific); authored: blender/pod_utility_authored.blend; finalize.log match; character: modular utility pod with shell/band, industrial wear |
...
**Assets with PRO treatment (with real evidence only):** 39 / 63 dedicated full verified by strict verify script (each with dedicated authored .blend, 3+ distinct PNGs from MCP render_viewport_to_path, 25+ line asset-specific deficiency.md with 2+ 'Before iter1 for <id>' + real per-iter MCP/character fixes, finalize.log matching, PRO note). 24 pending dedicated full. 137 unique PNG hashes, 42 authored. Table specific for the 39 (per-ID renders + def + authored); others representative. All skeptic gaps fixed (no bad refs/dups, specific defs, specific table for verified, visual/log expanded, authored for verified, tris correct, strict script, honest claims). Verif plan run (see SCRATCH). Do not claim until 63/63 dedicated + plan holds.
...
**REVAMP IN PROGRESS (not complete):** 2026-07-05 - 43/63 assets fully verified via strict per-ID evidence (distinct MD5 PNGs >=3, def.md >=25 lines + 2+ 'Before iter1 for <id>' + id mentions + iter + MCP + character, matching finalize.log, authored.blend). 146+ unique PNG hashes. Strict verify global: 43/63. Queue updated (added pod_utility after full MCP). MCP renders + dedicated defs + authored for the 43. All techniques from professional-techniques.md in verified. Verification plan steps executed + confirmed (STEP1 checks failureCount=0; STEP2 global 43/63 146 unique; STEP3 PNG 146; STEP4 authored 44; STEP5 evidence def/pngs true; STEP6 GOAL honest 43 no COMPLETE. Outputs in scratch/verification_plan_steps.txt). Do not claim COMPLETE until 63 verified + >=20 distinct + checks 0-fail + verification plan passes + all skeptic gaps fixed. See scratch/. Work continues. Single gap: 43/63 not 63/63 dedicated verified (plan steps 1+3 do not hold).
- .devshots/graphics-revamp/2026-07-05_skid_trio_clay.png — clay for skid trio (form after bevel).
- .devshots/graphics-revamp/2026-07-05_skid_trio_lit.png — lit.
- .devshots/graphics-revamp/2026-07-05_skid_trio_close.png — close.
- .devshots/graphics-revamp/2026-07-05_skid_quad_clay.png — clay for skid quad (form after bevel).
- .devshots/graphics-revamp/2026-07-05_skid_quad_lit.png — lit.
- .devshots/graphics-revamp/2026-07-05_skid_quad_close.png — close.
- .devshots/graphics-revamp/2026-07-05_pod_utility_clay.png — clay for pod utility (form after bevel).
- .devshots/graphics-revamp/2026-07-05_pod_utility_lit.png — lit.
- .devshots/graphics-revamp/2026-07-05_pod_utility_close.png — close.
