"""Build Hitch hero V63 (cycle 54): overlapping dorsal courses."""
...
from hitch_hero_v63 import PASS_ID, apply_hitch_hero_v63  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V63-054"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v63" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_54"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV63.build.v1",
        "status": "complete",
        "packet": PACKET,
