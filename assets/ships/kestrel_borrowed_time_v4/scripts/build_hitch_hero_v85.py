"""Build Hitch hero V85 (cycle 76): standing seams on the three-band laps."""
...
from hitch_hero_v85 import PASS_ID, apply_hitch_hero_v85  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V85-076"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v85" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_76"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV85.build.v1",
        "status": "complete",
        "packet": PACKET,
