"""Build Hitch hero V66 (cycle 57): wrap the strip into the openings."""
...
from hitch_hero_v66 import PASS_ID, apply_hitch_hero_v66  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V66-057"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v66" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_57"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV66.build.v1",
        "status": "complete",
        "packet": PACKET,
