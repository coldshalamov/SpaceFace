"""Build Hitch hero V39 (cycle 30): sloped casemate, short rims, taller mast."""
...
from hitch_hero_v39 import PASS_ID, apply_hitch_hero_v39  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V39-030"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v39" / "wholeships"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV39.build.v1",
        "status": "complete",
        "packet": PACKET,
