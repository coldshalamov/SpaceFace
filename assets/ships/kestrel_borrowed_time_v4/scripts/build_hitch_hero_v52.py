"""Build Hitch hero V52 (cycle 43): recesses in the crown."""
...
from hitch_hero_v52 import PASS_ID, apply_hitch_hero_v52  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V52-043"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v52" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_43"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV52.build.v1",
        "status": "complete",
        "packet": PACKET,
