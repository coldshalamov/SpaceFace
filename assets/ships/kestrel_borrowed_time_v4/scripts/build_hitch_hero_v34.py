"""Build Hitch hero V34 (cycle 25): steel well interiors."""
...
from hitch_hero_v34 import PASS_ID, apply_hitch_hero_v34  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V34-025"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v34" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_25"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV34.build.v1",
        "status": "complete",
        "packet": PACKET,
