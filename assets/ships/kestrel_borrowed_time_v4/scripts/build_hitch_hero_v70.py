"""Build Hitch hero V70 (cycle 61): shingled rolled courses."""
...
from hitch_hero_v70 import PASS_ID, apply_hitch_hero_v70  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V70-061"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v70" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_61"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV70.build.v1",
        "status": "complete",
        "packet": PACKET,
