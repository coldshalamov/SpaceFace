"""Build Hitch hero V97 (cycle 87): casemate cheek plates."""
...
from hitch_hero_v97 import PASS_ID, apply_hitch_hero_v97  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V97-087"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v97" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_87"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV97.build.v1",
        "status": "complete",
        "packet": PACKET,
