"""Build Hitch hero V101 (cycle 91): holed casemate courses with inspection wells."""
...
from hitch_hero_v101 import PASS_ID, apply_hitch_hero_v101  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V101-091"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v101" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_91"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV101.build.v1",
        "status": "complete",
        "packet": PACKET,
