"""Build Hitch hero V80 (cycle 71): two overlapping cone bands, no stamp lids."""
...
from hitch_hero_v80 import PASS_ID, apply_hitch_hero_v80  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V80-071"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v80" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_71"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV80.build.v1",
        "status": "complete",
        "packet": PACKET,
