"""Build Hitch hero V40 (cycle 31): gameplay-zoom well holes."""
...
from hitch_hero_v40 import PASS_ID, apply_hitch_hero_v40  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V40-031"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v40" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_31"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV40.build.v1",
        "status": "complete",
        "packet": PACKET,
