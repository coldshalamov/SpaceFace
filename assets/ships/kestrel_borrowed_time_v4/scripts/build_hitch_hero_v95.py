"""Build Hitch hero V95 (cycle 86): frame all four edges of each tile."""
...
from hitch_hero_v95 import PASS_ID, apply_hitch_hero_v95  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V95-086"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v95" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_86"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV95.build.v1",
        "status": "complete",
        "packet": PACKET,
