"""Build Hitch hero V108 (cycle 98): closed covers over the casemate wells.

Authored, not applied, not exported, not wired. Do not promote.
"""
...
from hitch_hero_v108 import PASS_ID, apply_hitch_hero_v108  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V108-098"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v108" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_98"
...
def cameras_from_bounds(bounds):
    ...
    return {
        ...
        "casemate_close.png": (
            Vector((9.15, -3.85, 3.20)),
            Vector((8.90, -0.62, 2.02)),
            36,
            None,
        ),
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV108.build.v1",
        "status": "complete",
        "packet": PACKET,
