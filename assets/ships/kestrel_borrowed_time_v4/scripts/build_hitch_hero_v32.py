"""Build Hitch hero V32 (cycle 23): constructed bow gun deck."""
...
from hitch_hero_v32 import PASS_ID, apply_hitch_hero_v32  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V32-023"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v32" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_23"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV32.build.v1",
        "status": "complete",
        "packet": PACKET,
