"""Build Hitch hero V91 (cycle 82): stepped shingles."""
...
from hitch_hero_v91 import PASS_ID, apply_hitch_hero_v91  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V91-082"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v91" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_82"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV91.build.v1",
        "status": "complete",
        "packet": PACKET,
