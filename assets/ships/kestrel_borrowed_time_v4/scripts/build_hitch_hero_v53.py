"""Build Hitch hero V53 (cycle 44): hide leftover spine ribs."""
...
from hitch_hero_v53 import PASS_ID, apply_hitch_hero_v53  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V53-044"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v53" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_44"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV53.build.v1",
        "status": "complete",
        "packet": PACKET,
