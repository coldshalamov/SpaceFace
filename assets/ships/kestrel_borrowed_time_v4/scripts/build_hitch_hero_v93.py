"""Build Hitch hero V93 (cycle 84): bolt rows on the 3Q face."""
...
from hitch_hero_v93 import PASS_ID, apply_hitch_hero_v93  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V93-084"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v93" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_84"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV93.build.v1",
        "status": "complete",
        "packet": PACKET,
