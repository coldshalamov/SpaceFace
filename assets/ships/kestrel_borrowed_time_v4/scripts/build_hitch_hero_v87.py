"""Build Hitch hero V87 (cycle 78): thick long lap joints, keep the clips."""
...
from hitch_hero_v87 import PASS_ID, apply_hitch_hero_v87  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V87-078"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v87" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_78"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV87.build.v1",
        "status": "complete",
        "packet": PACKET,
