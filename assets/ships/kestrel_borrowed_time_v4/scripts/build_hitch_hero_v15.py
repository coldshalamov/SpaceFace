...
from hitch_hero_v15 import PASS_ID, apply_hitch_hero_v15  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V15-006"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v15" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_06"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV15.build.v1",
        "status": "complete",
        "packet": PACKET,
