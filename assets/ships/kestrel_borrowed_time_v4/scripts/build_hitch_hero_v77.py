"""Build Hitch hero V77 (cycle 68): five overlapping cone courses."""
...
from hitch_hero_v77 import PASS_ID, apply_hitch_hero_v77  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V77-068"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v77" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_68"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV77.build.v1",
        "status": "complete",
        "packet": PACKET,
