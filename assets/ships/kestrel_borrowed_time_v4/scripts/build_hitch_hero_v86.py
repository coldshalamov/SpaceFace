"""Build Hitch hero V86 (cycle 77): hat-section joints on the cone laps."""
...
from hitch_hero_v86 import PASS_ID, apply_hitch_hero_v86  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V86-077"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v86" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_77"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV86.build.v1",
        "status": "complete",
        "packet": PACKET,
