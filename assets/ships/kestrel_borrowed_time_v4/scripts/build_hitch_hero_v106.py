"""Build Hitch hero V106 (cycle 96): service run on the casemate cheek."""
...
from hitch_hero_v106 import PASS_ID, apply_hitch_hero_v106  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V106-096"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v106" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_96"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV106.build.v1",
        "status": "complete",
        "packet": PACKET,
