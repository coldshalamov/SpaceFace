"""Build Hitch hero V67 (cycle 58): overlapping cambered access lids."""
...
from hitch_hero_v67 import PASS_ID, apply_hitch_hero_v67  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V67-058"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v67" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_58"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV67.build.v1",
        "status": "complete",
        "packet": PACKET,
