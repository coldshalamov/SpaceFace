"""Build Hitch hero V33 (cycle 24): narrow armor gun trench."""
...
from hitch_hero_v33 import PASS_ID, apply_hitch_hero_v33  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V33-024"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v33" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_24"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV33.build.v1",
        "status": "complete",
        "packet": PACKET,
