"""Build Hitch hero V27 (cycle 18): look-down hull bays in the pressure vessel."""
...
from hitch_hero_v27 import PASS_ID, apply_hitch_hero_v27  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V27-018"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v27" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_18"
...
def cameras_from_bounds(bounds):
    ...
    # Blender Z-up equivalent of the gameplay Y-up chase camera.
...
def render_stills(bounds):
    ...
    for name, loc, energy, color, size in (
        ...
        ("V24Down", tuple(center + Vector((0.0, 0.0, span * 1.6))), 4200, (0.80, 0.84, 0.90), 14),
    ):
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV27.build.v1",
        "status": "complete",
        "packet": PACKET,
