"""Build Hitch hero V42 (cycle 33): slatted outboard fins."""
...
from hitch_hero_v42 import PASS_ID, apply_hitch_hero_v42  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V42-033"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v42" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_33"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV42.build.v1",
        "status": "complete",
        "packet": PACKET,
