"""Build Hitch hero V79 (cycle 70): rolled overlapping cone armor with hatches."""
...
from hitch_hero_v79 import PASS_ID, apply_hitch_hero_v79  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V79-070"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v79" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_70"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV79.build.v1",
        "status": "complete",
        "packet": PACKET,
