"""Build Hitch hero V61 (cycle 52): hull-strip seams and hatch."""
...
from hitch_hero_v61 import PASS_ID, apply_hitch_hero_v61  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V61-052"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v61" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_52"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV61.build.v1",
        "status": "complete",
        "packet": PACKET,
