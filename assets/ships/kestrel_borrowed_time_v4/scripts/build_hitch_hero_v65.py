"""Build Hitch hero V65 (cycle 56): plates cover the whole gray strip."""
...
from hitch_hero_v65 import PASS_ID, apply_hitch_hero_v65  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V65-056"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v65" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_56"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV65.build.v1",
        "status": "complete",
        "packet": PACKET,
