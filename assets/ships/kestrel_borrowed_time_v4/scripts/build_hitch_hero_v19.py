"""Build Hitch hero V19 (cycle 10): non-emissive tunnel and cut shoulder lids."""
...
from hitch_hero_v19 import PASS_ID, apply_hitch_hero_v19  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V19-010"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v19" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_10"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV19.build.v1",
        "status": "complete",
        "packet": PACKET,
