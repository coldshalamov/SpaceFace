"""Build Hitch hero V57 (cycle 48): open the spine trench."""
...
from hitch_hero_v57 import PASS_ID, apply_hitch_hero_v57  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V57-048"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v57" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_48"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV57.build.v1",
        "status": "complete",
        "packet": PACKET,
