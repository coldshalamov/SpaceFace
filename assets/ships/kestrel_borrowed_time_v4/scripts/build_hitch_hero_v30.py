"""Build Hitch hero V30 (cycle 21): bow magazine wells."""
...
from hitch_hero_v30 import PASS_ID, apply_hitch_hero_v30  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V30-021"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v30" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_21"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV30.build.v1",
        "status": "complete",
        "packet": PACKET,
