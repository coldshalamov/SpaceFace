"""Build Hitch hero V81 (cycle 72): inspection lids on the shingled cone bands."""
...
from hitch_hero_v81 import PASS_ID, apply_hitch_hero_v81  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V81-072"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v81" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_72"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV81.build.v1",
        "status": "complete",
        "packet": PACKET,
