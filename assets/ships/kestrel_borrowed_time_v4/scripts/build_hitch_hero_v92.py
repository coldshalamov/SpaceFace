"""Build Hitch hero V92 (cycle 83): a step the store-shot can count."""
...
from hitch_hero_v92 import PASS_ID, apply_hitch_hero_v92  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V92-083"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v92" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_83"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV92.build.v1",
        "status": "complete",
        "packet": PACKET,
