"""Build Hitch hero V55 (cycle 46): hide cycle-16 course cards."""
...
from hitch_hero_v55 import PASS_ID, apply_hitch_hero_v55  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V55-046"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v55" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_46"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV55.build.v1",
        "status": "complete",
        "packet": PACKET,
