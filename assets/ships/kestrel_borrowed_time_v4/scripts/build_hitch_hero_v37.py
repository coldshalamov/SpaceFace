"""Build Hitch hero V37 (cycle 28): tall hat housings."""
...
from hitch_hero_v37 import PASS_ID, apply_hitch_hero_v37  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V37-028"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v37" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_28"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV37.build.v1",
        "status": "complete",
        "packet": PACKET,
