"""Build Hitch hero V99 (cycle 89): shingle the casemate cheek."""
...
from hitch_hero_v99 import PASS_ID, apply_hitch_hero_v99  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V99-089"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v99" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_89"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV99.build.v1",
        "status": "complete",
        "packet": PACKET,
