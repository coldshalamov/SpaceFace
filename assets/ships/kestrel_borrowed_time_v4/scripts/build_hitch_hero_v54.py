"""Build Hitch hero V54 (cycle 45): hide leftover spine studs."""
...
from hitch_hero_v54 import PASS_ID, apply_hitch_hero_v54  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V54-045"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v54" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_45"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV54.build.v1",
        "status": "complete",
        "packet": PACKET,
