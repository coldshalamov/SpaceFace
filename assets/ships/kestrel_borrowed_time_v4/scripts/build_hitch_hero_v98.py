"""Build Hitch hero V98 (cycle 88): seams on the casemate plate laps."""
...
from hitch_hero_v98 import PASS_ID, apply_hitch_hero_v98  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V98-088"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v98" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_88"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV98.build.v1",
        "status": "complete",
        "packet": PACKET,
