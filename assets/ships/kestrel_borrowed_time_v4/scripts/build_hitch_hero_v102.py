"""Build Hitch hero V102 (cycle 92): real doors in the casemate wells."""
...
from hitch_hero_v102 import PASS_ID, apply_hitch_hero_v102  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V102-092"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v102" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_92"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV102.build.v1",
        "status": "complete",
        "packet": PACKET,
