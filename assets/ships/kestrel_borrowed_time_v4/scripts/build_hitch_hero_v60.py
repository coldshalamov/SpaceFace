"""Build Hitch hero V60 (cycle 51): formed well lips."""
...
from hitch_hero_v60 import PASS_ID, apply_hitch_hero_v60  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V60-051"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v60" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_51"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV60.build.v1",
        "status": "complete",
        "packet": PACKET,
