"""Build Hitch hero V74 (cycle 65): overlapping cone-flank courses."""
...
from hitch_hero_v74 import PASS_ID, apply_hitch_hero_v74  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V74-065"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v74" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_65"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV74.build.v1",
        "status": "complete",
        "packet": PACKET,
