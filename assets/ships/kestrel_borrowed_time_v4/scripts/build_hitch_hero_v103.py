"""Build Hitch hero V103 (cycle 93): flush doors filling the casemate wells."""
...
from hitch_hero_v103 import PASS_ID, apply_hitch_hero_v103  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V103-093"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v103" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_93"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV103.build.v1",
        "status": "complete",
        "packet": PACKET,
