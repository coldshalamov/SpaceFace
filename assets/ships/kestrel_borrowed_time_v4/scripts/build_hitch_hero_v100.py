"""Build Hitch hero V100 (cycle 90): hatches on the casemate shingles."""
...
from hitch_hero_v100 import PASS_ID, apply_hitch_hero_v100  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V100-090"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v100" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_90"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV100.build.v1",
        "status": "complete",
        "packet": PACKET,
