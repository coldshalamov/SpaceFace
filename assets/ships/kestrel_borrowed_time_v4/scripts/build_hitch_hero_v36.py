"""Build Hitch hero V36 (cycle 27): formed well housings."""
...
from hitch_hero_v36 import PASS_ID, apply_hitch_hero_v36  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V36-027"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v36" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_27"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV36.build.v1",
        "status": "complete",
        "packet": PACKET,
