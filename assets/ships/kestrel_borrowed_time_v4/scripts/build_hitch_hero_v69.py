"""Build Hitch hero V69 (cycle 60): plated course under the thick lids."""
...
from hitch_hero_v69 import PASS_ID, apply_hitch_hero_v69  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V69-060"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v69" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_60"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV69.build.v1",
        "status": "complete",
        "packet": PACKET,
