"""Build Hitch hero V50 (cycle 41): formed dorsal crown."""
...
from hitch_hero_v50 import PASS_ID, apply_hitch_hero_v50  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V50-041"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v50" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_41"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV50.build.v1",
        "status": "complete",
        "packet": PACKET,
