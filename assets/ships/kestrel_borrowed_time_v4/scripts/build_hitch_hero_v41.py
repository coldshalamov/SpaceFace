"""Build Hitch hero V41 (cycle 32): play-scale sponson hats."""
...
from hitch_hero_v41 import PASS_ID, apply_hitch_hero_v41  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V41-032"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v41" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_32"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV41.build.v1",
        "status": "complete",
        "packet": PACKET,
