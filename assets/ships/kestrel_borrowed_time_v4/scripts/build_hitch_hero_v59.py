"""Build Hitch hero V59 (cycle 50): formed trench lips."""
...
from hitch_hero_v59 import PASS_ID, apply_hitch_hero_v59  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V59-050"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v59" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_50"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV59.build.v1",
        "status": "complete",
        "packet": PACKET,
