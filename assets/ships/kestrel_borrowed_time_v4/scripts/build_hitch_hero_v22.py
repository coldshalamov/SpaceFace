"""Build Hitch hero V22 (cycle 13): cut holes through the underframe deck."""
...
from hitch_hero_v22 import PASS_ID, apply_hitch_hero_v22  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V22-013"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v22" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_13"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV22.build.v1",
        "status": "complete",
        "packet": PACKET,
