"""Build Hitch hero V64 (cycle 55): brake-formed plate courses."""
...
from hitch_hero_v64 import PASS_ID, apply_hitch_hero_v64  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V64-055"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v64" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_55"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV64.build.v1",
        "status": "complete",
        "packet": PACKET,
