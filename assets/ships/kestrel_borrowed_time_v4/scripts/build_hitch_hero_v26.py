"""Build Hitch hero V26 (cycle 17): chines so the table sees a stepped hull."""
...
from hitch_hero_v26 import PASS_ID, apply_hitch_hero_v26  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V26-017"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v26" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_17"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV26.build.v1",
        "status": "complete",
        "packet": PACKET,
