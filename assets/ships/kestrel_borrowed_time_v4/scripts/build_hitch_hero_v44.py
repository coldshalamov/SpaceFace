"""Build Hitch hero V44 (cycle 35): formed repair-pack housings."""
...
from hitch_hero_v44 import PASS_ID, apply_hitch_hero_v44  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V44-035"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v44" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_35"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV44.build.v1",
        "status": "complete",
        "packet": PACKET,
