"""Build Hitch hero V94 (cycle 85): folded lips on the 3Q plate edges."""
...
from hitch_hero_v94 import PASS_ID, apply_hitch_hero_v94  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V94-085"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v94" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_85"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV94.build.v1",
        "status": "complete",
        "packet": PACKET,
