"""Build Hitch hero V46 (cycle 37): taller starboard pack frame."""
...
from hitch_hero_v46 import PASS_ID, apply_hitch_hero_v46  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V46-037"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v46" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_37"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV46.build.v1",
        "status": "complete",
        "packet": PACKET,
