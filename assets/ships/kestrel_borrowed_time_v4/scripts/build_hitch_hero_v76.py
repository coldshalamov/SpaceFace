"""Build Hitch hero V76 (cycle 67): lids on the tight-rolled shell."""
...
from hitch_hero_v76 import PASS_ID, apply_hitch_hero_v76  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V76-067"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v76" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_67"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV76.build.v1",
        "status": "complete",
        "packet": PACKET,
