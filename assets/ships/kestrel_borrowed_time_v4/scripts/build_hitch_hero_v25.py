"""Build Hitch hero V25 (cycle 16): bigger wells + dorsal courses."""
...
from hitch_hero_v25 import PASS_ID, apply_hitch_hero_v25  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V25-016"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v25" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_16"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV25.build.v1",
        "status": "complete",
        "packet": PACKET,
