"""Build Hitch hero V51 (cycle 42): open the V5 hatch lids."""
...
from hitch_hero_v51 import PASS_ID, apply_hitch_hero_v51  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V51-042"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v51" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_42"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV51.build.v1",
        "status": "complete",
        "packet": PACKET,
