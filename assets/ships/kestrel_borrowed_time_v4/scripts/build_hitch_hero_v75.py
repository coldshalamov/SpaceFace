"""Build Hitch hero V75 (cycle 66): thick proud cone courses."""
...
from hitch_hero_v75 import PASS_ID, apply_hitch_hero_v75  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V75-066"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v75" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_66"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV75.build.v1",
        "status": "complete",
        "packet": PACKET,
