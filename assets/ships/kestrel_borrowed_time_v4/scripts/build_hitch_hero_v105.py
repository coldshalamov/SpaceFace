"""Build Hitch hero V105 (cycle 95): bolts on the casemate standing seams."""
...
from hitch_hero_v105 import PASS_ID, apply_hitch_hero_v105  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V105-095"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v105" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_95"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV105.build.v1",
        "status": "complete",
        "packet": PACKET,
