"""Build Hitch hero V104 (cycle 94): standing seams between casemate courses."""
...
from hitch_hero_v104 import PASS_ID, apply_hitch_hero_v104  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V104-094"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v104" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_94"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV104.build.v1",
        "status": "complete",
        "packet": PACKET,
