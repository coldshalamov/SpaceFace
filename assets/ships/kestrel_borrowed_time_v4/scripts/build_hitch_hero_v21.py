"""Build Hitch hero V21 (cycle 12): hide DIE LAUGHING card, open pit mouths."""
...
from hitch_hero_v21 import PASS_ID, apply_hitch_hero_v21  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V21-012"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v21" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_12"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV21.build.v1",
        "status": "complete",
        "packet": PACKET,
