"""Build Hitch hero V72 (cycle 63): rolled shell courses."""
...
from hitch_hero_v72 import PASS_ID, apply_hitch_hero_v72  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V72-063"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v72" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_63"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV72.build.v1",
        "status": "complete",
        "packet": PACKET,
