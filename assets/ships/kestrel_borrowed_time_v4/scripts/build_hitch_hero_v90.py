"""Build Hitch hero V90 (cycle 81): shingle the gapped tiles."""
...
from hitch_hero_v90 import PASS_ID, apply_hitch_hero_v90  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V90-081"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v90" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_81"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV90.build.v1",
        "status": "complete",
        "packet": PACKET,
