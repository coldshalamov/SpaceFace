"""Build Hitch hero V28 (cycle 19): deeper hull bays + filled trench."""
...
from hitch_hero_v28 import PASS_ID, apply_hitch_hero_v28  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V28-019"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v28" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_19"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV28.build.v1",
        "status": "complete",
        "packet": PACKET,
