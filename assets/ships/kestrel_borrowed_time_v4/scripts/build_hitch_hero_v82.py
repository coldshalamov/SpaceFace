"""Build Hitch hero V82 (cycle 73): recessed lids and a cone service run."""
...
from hitch_hero_v82 import PASS_ID, apply_hitch_hero_v82  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V82-073"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v82" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_73"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV82.build.v1",
        "status": "complete",
        "packet": PACKET,
