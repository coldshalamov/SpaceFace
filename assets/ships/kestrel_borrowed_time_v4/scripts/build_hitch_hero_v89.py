"""Build Hitch hero V89 (cycle 80): steel joints and face fasteners."""
...
from hitch_hero_v89 import PASS_ID, apply_hitch_hero_v89  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V89-080"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v89" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_80"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV89.build.v1",
        "status": "complete",
        "packet": PACKET,
