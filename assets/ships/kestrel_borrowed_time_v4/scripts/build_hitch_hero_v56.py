"""Build Hitch hero V56 (cycle 47): hide the original spine slab."""
...
from hitch_hero_v56 import PASS_ID, apply_hitch_hero_v56  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V56-047"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v56" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_47"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV56.build.v1",
        "status": "complete",
        "packet": PACKET,
