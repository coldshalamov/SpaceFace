"""Build Hitch hero V31 (cycle 22): deeper fore wells."""
...
from hitch_hero_v31 import PASS_ID, apply_hitch_hero_v31  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V31-022"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v31" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_22"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV31.build.v1",
        "status": "complete",
        "packet": PACKET,
