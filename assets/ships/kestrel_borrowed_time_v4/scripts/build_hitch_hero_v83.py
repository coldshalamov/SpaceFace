"""Build Hitch hero V83 (cycle 74): four-wall inspection wells on the cone."""
...
from hitch_hero_v83 import PASS_ID, apply_hitch_hero_v83  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V83-074"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v83" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_74"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV83.build.v1",
        "status": "complete",
        "packet": PACKET,
