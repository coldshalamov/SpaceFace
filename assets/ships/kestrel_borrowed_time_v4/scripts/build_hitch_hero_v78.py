"""Build Hitch hero V78 (cycle 69): upper-cone face courses."""
...
from hitch_hero_v78 import PASS_ID, apply_hitch_hero_v78  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V78-069"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v78" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_69"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV78.build.v1",
        "status": "complete",
        "packet": PACKET,
