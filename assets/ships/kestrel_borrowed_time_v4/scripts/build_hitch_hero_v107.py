"""Build Hitch hero V107 (cycle 97): saddles under the casemate service run."""
...
from hitch_hero_v107 import PASS_ID, apply_hitch_hero_v107  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V107-097"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v107" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_97"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV107.build.v1",
        "status": "complete",
        "packet": PACKET,
