"""Build Hitch hero V84 (cycle 75): three overlapping cone bands."""
...
from hitch_hero_v84 import PASS_ID, apply_hitch_hero_v84  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V84-075"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v84" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_75"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV84.build.v1",
        "status": "complete",
        "packet": PACKET,
