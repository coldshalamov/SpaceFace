"""Build Hitch hero V38 (cycle 29): play-scale casemate, rims, mast."""
...
from hitch_hero_v38 import PASS_ID, apply_hitch_hero_v38  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V38-029"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v38" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_29"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV38.build.v1",
        "status": "complete",
        "packet": PACKET,
