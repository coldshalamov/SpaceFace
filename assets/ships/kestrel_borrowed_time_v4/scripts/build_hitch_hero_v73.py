"""Build Hitch hero V73 (cycle 64): tighter rolled courses."""
...
from hitch_hero_v73 import PASS_ID, apply_hitch_hero_v73  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V73-064"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v73" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_64"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV73.build.v1",
        "status": "complete",
        "packet": PACKET,
