"""Build Hitch hero V29 (cycle 20): steel lips on the hull bays."""
...
from hitch_hero_v29 import PASS_ID, apply_hitch_hero_v29  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V29-020"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v29" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_20"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV29.build.v1",
        "status": "complete",
        "packet": PACKET,
