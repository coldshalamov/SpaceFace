"""Build Hitch hero V20 (cycle 11): hide remaining sponson lids."""
...
from hitch_hero_v20 import PASS_ID, apply_hitch_hero_v20  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V20-011"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v20" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_11"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV20.build.v1",
        "status": "complete",
        "packet": PACKET,
