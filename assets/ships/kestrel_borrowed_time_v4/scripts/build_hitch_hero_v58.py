"""Build Hitch hero V58 (cycle 49): formed furniture in the open trench."""
...
from hitch_hero_v58 import PASS_ID, apply_hitch_hero_v58  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V58-049"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v58" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_49"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV58.build.v1",
        "status": "complete",
        "packet": PACKET,
