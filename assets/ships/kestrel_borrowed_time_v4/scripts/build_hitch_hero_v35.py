"""Build Hitch hero V35 (cycle 26): proud well hardware."""
...
from hitch_hero_v35 import PASS_ID, apply_hitch_hero_v35  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V35-026"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v35" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_26"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV35.build.v1",
        "status": "complete",
        "packet": PACKET,
