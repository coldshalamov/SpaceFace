"""Build Hitch hero V62 (cycle 53): gray strip becomes an armor course."""
...
from hitch_hero_v62 import PASS_ID, apply_hitch_hero_v62  # noqa: E402


FAMILY = Path(__file__).resolve().parents[1]
BASELINE = FAMILY / "blender" / "kestrel_hitch_polish_v7_production.blend"
PACKET = "SF-K0-HITCH-HERO-V62-053"
OUT_DIR = FAMILY / "source_candidates" / "hitch_hero_v62" / "wholeships"
EVIDENCE = FAMILY / "evidence" / "hitch" / "cycles" / "cycle_53"
...
def main() -> int:
    ...
    result = {
        "schema": "spaceface.hitchHeroV62.build.v1",
        "status": "complete",
        "packet": PACKET,
