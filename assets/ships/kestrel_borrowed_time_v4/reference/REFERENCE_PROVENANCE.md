...
| Crew identity stencil — `kestrel_die_laughing_stencil_reference_v2.png` | No source raster; generated as an isolated lettering/component study | Original horizontal two-line `DIE LAUGHING` crew marking with hand-cut stencil bridges, late-1990s underground protest-punk energy, dirty warm-ivory spray paint, irregular overspray, chips, scratches and sparse drips over graphite-coated metal; explicitly exclude copied album artwork, logos, fists, skulls, clean digital typography, neon and plastic. | Original conventionally rebuilt stencil glyphs, broken paint bridges, uneven baseline, edge overspray, chips and scrape loss. Exact readable text is authored in Blender; generated pixels are never projected or shipped. | Copying a protected cover, artist mark or font; raster projection; generated text; decorative emissive plaque; clean extruded desktop typography. | `EB4CA35AE6B22817037FA7717C7C9CACEEEAB65965730F7F388A7FE5E5036ECF` |
