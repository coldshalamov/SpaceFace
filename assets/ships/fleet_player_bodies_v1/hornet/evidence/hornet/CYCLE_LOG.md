...
| 193 | yes | C83491BD | REVISE pending independent review | Final-binary correction: embedded PNG ladder is verified 4096/2048/1024; indexed visible triangles are 46,555/31,852/18,819 and visible primitive submits are 65/55/44; post-modifier triangulation and tangent generation produce valid tangents on all normal-mapped primitives; wings gain a thicker separated flap channel/lower load path; radiator cassette gains deeper rim/core/header/mounts; material grid response is reduced. Exact C193 hashes and three pending review slots are in `cycle_193.json`. C85 remains live; not wired. |
| 194 | yes | 0E5B82D2 | REVISE pending independent review | C194 response to the C193 structural-read review: mechanical wing-root fairings, formed lower load paths, dark separated flap/channel, and a deeper radiator cassette with header feed and sloped rooted mounts. Final binary ladder is 48,315/33,588/20,515 triangles, 68/58/47 visible submits, 4096/2048/1024 maps, and 68/58/47 tangent-ready visible primitives. Mesh validation removes prior LOD0/LOD2 invalid-mesh warnings; Blender's intentional multi-image sampler advisory is documented with correct exported channel bindings. Candidate remains unpromoted; whole-asset Hitch floor is still REVISE. |
| 195 | yes | 25352093 | REVISE pending independent review | Whole-hull articulation pass: four connected service zones (nose/canopy shoulders, spine/shoulder load paths, wing torque/hinge, aft drive service) add real depth and calm value hierarchy while preserving C194 canopy, thick roots/flap channel, recessed radiator, twin throats, map ladder, and tangents. Final binary ladder is 49,863/35,136/21,295 triangles, 85/75/56 visible submits, 4096/2048/1024 maps, and 85/75/56 tangent-ready visible primitives. Foundry passes; Khronos wrapper remains unavailable due to the documented external module gap. Candidate remains unpromoted; whole-asset Hitch floor is still REVISE. |
