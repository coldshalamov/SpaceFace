...
const PACKET = 'SF-PELICAN-PRODUCTION-V1-001';
const ASSET_ID = 'SF_PELICAN_PRODUCTION_V1';
...
const SOURCE = [0, 1, 2].map((lod) => resolve(FAMILY, `source/wholeships/pelican_production_v1_lod${lod}.glb`));
const CANDIDATE = [0, 1, 2].map((lod) => resolve(FAMILY, `release_candidates/wholeships/pelican_production_v1_lod${lod}.glb`));
...
const report = {
  schema: 'spaceface.pelicanProductionV1.finalize.v1',
  packet: PACKET,
  assetId: ASSET_ID,
