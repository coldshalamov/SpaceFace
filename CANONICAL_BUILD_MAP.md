...
|---|---|---|
| `.01` | Hornet | wired candidate C85, **not quality-closed**. C99 candidate: one hull, roof well, standing-off cans, no hanging keel tiles. Reviews still REVISE. Ledger incomplete. |
