...
| Unify the picture / one art direction / convergence / creative campaigns / superpower pass / make it A-list | **`build_map.md` §23**. A campaign is a feeling; invent the system. Outside resources, when one is needed: [`../docs/OPEN_SOURCE_INTAKE.md`](../docs/OPEN_SOURCE_INTAKE.md) §0. §22 is the measured gap list. Grunt lines stay in `design/program/INFERENCE_IDEAS.md` |
