...
| Hitching / stuttering / not playing smoothly | **`build_map.md` §8.4** → [`../design/program/PERF_HITCH_CAMPAIGN.md`](../design/program/PERF_HITCH_CAMPAIGN.md) → `PQ-129`. Measure first; do not cut quality |
