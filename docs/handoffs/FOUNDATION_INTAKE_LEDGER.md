...
- Agent-facing trace gate: `node scripts/sf-sim.mjs trace 47a --seed 47 --ticks 720 --inputs test/47a.inputs.json --events scenario.*,tether.*,combat.*,story.*,presentation.* --limit 220 --physics-backend rapier-dynamic`.
