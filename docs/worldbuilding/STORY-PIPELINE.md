...
| Leftover story ledger (PQ-178.03) | `node --test test/pq-178-03-ledger.test.mjs` — campaign receipts retell in order; the berth mechanic says `I was X, then Y, so I Z` |
