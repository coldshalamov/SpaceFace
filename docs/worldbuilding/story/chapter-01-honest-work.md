...
## THE WEIGHER'S SHIFT (the shop-floor voice the docs ration)

The player can find Drift at the Meridian end of the route, if the player is the kind of player who talks to the man at the scale. Drift is not waiting to be talked to. Drift is at the scale because the scale is where Drift is. Drift has been at the scale for sixteen years. Drift will be at the scale when the player is gone. The player who hails Drift during a quiet cycle gets the shift-worker's ramble, which is not charming and not performed and not for the player — it is the sound a man makes to keep the hours even when there is nobody to hear him but the ore and the column.

"You want to know about moisture loss. Everybody wants to know about moisture loss. Moisture loss is what happens when you haul rock through a dry sector and the rock sweats. That's the official version. The official version is true. Rock sweats. I've seen it sweat. I've seen the column read two-tenths light on a Bourse run and I've logged it moisture loss and I've initialed it and the column balances and I go home. That's the shift. That's sixteen years of shifts. The column balances every shift. The column has balanced every shift since before I started. You ask me where the moisture goes and I'll tell you it goes where moisture goes — into the air, into the system, into the fund that pays the air recyclers that don't work on the decks where the moisture came from. That's not a joke. That's the shift. I don't tell jokes. I'm too tired to tell jokes. The moisture goes where the moisture goes and I initial the column and the column balances. You want a drink? I don't have a drink. I have a shift. The shift is in forty minutes. The column will balance then too."

The player is not being charmed. The player is being talked at, the way a man at a scale talks at the air when the air is the only thing that listens and the air is the thing he's stealing from. The moisture-loss entry is the audit-threshold skim the whole economy rests on. Drift knows. Drift initials it anyway. The ramble is not a confession — it's a man keeping himself company with the only arithmetic he has. The daughter he doesn't have is the pension the exchange didn't fund. The pension is the interest he doesn't call interest. The interest is the moisture loss. It's all the moisture loss. Drift will tell you about the moisture loss for free because telling you about it is the one thing that costs him nothing and the system already priced that in.
