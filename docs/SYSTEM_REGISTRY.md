...
| `lawSecurity` | `systems/lawSecurity.js` | 4108 | 0 | 19 | — |
...
| `missions` | `systems/missions.js` | 8122 | 101 | 48 | `mission:updated`×47, `comms:popup`×6, `nav:waypoint`×5 |
...
| `masslineHud` | `ui/masslineHud.js` | 1576 | 0 | 2 | — |
