...
- 64×64 arithmetic-noise/grid images and a neutral normal stand in for object-specific surfacing;
...
actual image is 64×64; a present normal texture must not imply object-specific normal information
when it is flat.
