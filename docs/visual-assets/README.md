...
1. `VISUAL_ASSET_PRODUCTION_STANDARD.md` — states, craft outcomes, G0–G7 gates, budgets, and execution.
2. `SPACEFACE_MIGRATION.md` — repository-specific audit and migration plan.
3. `AGENT_PROMPTS.md` — reusable standards, one-asset, family, and independent-review prompts.
4. `TEMPLATES.md` — brief, performance, review, and acceptance record shapes.
