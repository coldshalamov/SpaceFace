#!/usr/bin/env python3
"""Conveyor-barge material-truth remaster (v2, non-promoting candidate).

v1 replaced the 2026-07 bevel-only boxes with a manufactured ore-transfer barge:
continuous keel and ribs, three deck cradles with seated corrugated containers, a
drive block whose four refractory throats flank the preserved trail hook, a glazed
command tower, and a forked loading boom whose tips carry the status optics at their
frozen world positions (70, +/-7.5, 6.2).  v2 repairs what v1's matched captures
measured: uninterrupted 46m side sheets reading as slabs, a monotone deck, a too-quiet
tower, louvers/manifolds missing on the drive block, and a glazed band too dim to read
at operating range.
...
def main() -> None:
    ...
    root["spaceface.surfaceRevision"] = "opening_conveyor_barge_v2"
    ...
    report = {
        "schema": "spaceface.openingConveyorBargeRemaster.v2",
