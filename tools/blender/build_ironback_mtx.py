...
def build_lod(lod, mats):
    ...
    for sign, side in ((-1, "Port"), (1, "Starboard")):
        ...
        add_box(f"ArmBoom_Fore_{side}", (2.4, 2.55 * sign, -0.15), (1.15, 0.10, 0.10), mech, collection, 0.008)
        add_box(f"ArmHead_Fore_{side}", (3.55, 2.70 * sign, -0.25), (0.22, 0.16, 0.16), armor, collection, 0.006)
        add_cylinder(f"Cutter_Fore_{side}", (4.05, 2.70 * sign, -0.25), 0.08, 0.55, ceramic, collection, vertices=10, bevel=0.004)
        add_box(f"ArmBoom_Aft_{side}", (-2.2, 2.55 * sign, -0.15), (1.15, 0.10, 0.10), mech, collection, 0.008)
        add_box(f"ArmHead_Aft_{side}", (-3.35, 2.70 * sign, -0.25), (0.22, 0.16, 0.16), armor, collection, 0.006)
        add_cylinder(f"Cutter_Aft_{side}", (-3.85, 2.70 * sign, -0.25), 0.08, 0.55, ceramic, collection, vertices=10, bevel=0.004)
