...
def build_lod(lod, mats):
    ...
    if lod <= 1:
        ...
        cut_open_bay(hull_obj, "Port", (0.20, -1.72, 0.18), 1.75, 0.42, 0.50, (0, -1, 0), mats, collection, kit="empty", liner=False)
        cut_open_bay(hull_obj, "Starboard", (0.20, 1.72, 0.18), 1.75, 0.42, 0.50, (0, 1, 0), mats, collection, kit="empty", liner=False)
        cut_open_bay(hull_obj, "TowerWell", (-2.40, 0.0, 1.18), 1.05, 0.62, 0.38, (0, 0, 1), mats, collection, kit="empty", liner=False)
    ...
    loft_shell("Casemate_P", [
        (3.20, -1.05, -1.72, -0.08, 0.42),
        (0.20, -1.28, -1.88, -0.10, 0.46),
        (-2.20, -1.05, -1.62, -0.06, 0.36),
    ...
    cover_loft_with_plates("BastionSkin", [
        (9.10, 0.32, 0.24, 0.08),
        (7.20, 0.70, 0.48, 0.14),
        (4.80, 1.16, 0.94, 0.24),
        (1.80, 1.68, 0.74, 0.14),
