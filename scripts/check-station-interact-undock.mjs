#!/usr/bin/env node
// Pure UI-input contract for station airlock parity.
//
// The visible station Undock button, Esc, gamepad cancel, and backdrop already use the shared
// dock:undocked contract. This guards the keyboard interact path: the same live binding that docks
// from flight must also undock from the station hub, while Enter remains free for focused controls.
