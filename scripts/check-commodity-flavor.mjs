...
// Frozen balance baseline extended only when production adds or deliberately specializes a row.
const BASELINE = [
  ...
  { id: 'cmdty_exotic_amazonite', name: 'Storm-Glass', category: 'raw ore', basePrice: 500000, volatility: 0.60, elasticity: 0.80, legality: 'legal', volPerU: 0.8, massPerU: 0.8, fineMult: 0, producedBy: ['mining', 'blackmarket'], consumedBy: ['trade_hub', 'research'] },
  ...
  { id: 'cmdty_crystal_lumin', name: 'Emitter Crystal', category: 'crystal', basePrice: 105, volatility: 0.30, elasticity: 0.46, legality: 'legal', volPerU: 1.0, massPerU: 1.0, fineMult: 0, producedBy: ['mining'], consumedBy: ['fab', 'research'] },
  ...
  { id: 'cmdty_fuel_cells', name: 'Refined Fuel Cells', category: 'refined', basePrice: 95, volatility: 0.26, elasticity: 0.50, legality: 'legal', volPerU: 0.8, massPerU: 0.6, fineMult: 0, producedBy: ['refinery'], consumedBy: ['trade_hub', 'military', 'mining'] },
  ...
  { id: 'cmdty_textiles', name: 'Drifter-Silk', category: 'consumer', basePrice: 60, volatility: 0.22, elasticity: 0.40, legality: 'legal', volPerU: 1.0, massPerU: 0.6, fineMult: 0, producedBy: ['fab'], consumedBy: ['trade_hub'] },
  { id: 'cmdty_luxury_goods', name: 'Shrine Lanterns', category: 'luxury', basePrice: 190, volatility: 0.40, elasticity: 0.42, legality: 'legal', volPerU: 0.9, massPerU: 0.4, fineMult: 0, producedBy: ['trade_hub', 'fab'], consumedBy: ['trade_hub', 'blackmarket'] },
  { id: 'cmdty_art', name: 'Pre-Collapse Artifacts', category: 'luxury', basePrice: 300, volatility: 0.45, elasticity: 0.50, legality: 'restricted', volPerU: 0.7, massPerU: 0.3, fineMult: 0.8, producedBy: ['trade_hub'], consumedBy: ['trade_hub', 'blackmarket'] },
  ...
  { id: 'cmdty_munitions', name: 'Charge-Case Munitions', category: 'military', basePrice: 115, volatility: 0.32, elasticity: 0.48, legality: 'restricted', volPerU: 0.6, massPerU: 1.1, fineMult: 0.8, producedBy: ['military', 'fab'], consumedBy: ['military', 'blackmarket'] },
  ...
  // Field-crafting trade rows (2026-08-14); flavor arrived in the Plan 58 consolidation.
