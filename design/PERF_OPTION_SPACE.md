...
| **`PQ-123` / `PERF-83-INSTANCE-FAR-CULL`** | Near INV | Instance far cull is leftover 9000 WU / 420 pad. | Census whether submit already dropped those slots. Shrink only if leaked. | No horizon instance tax; on-glass batches stay. |
