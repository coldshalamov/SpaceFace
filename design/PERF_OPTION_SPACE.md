...
| **`PQ-123` / `PERF-83-INSTANCE-FAR-CULL`** | Near IMPL | Instance far cull follows the max-zoom table, not a leftover 9000 WU horizon. | Submit already drops off-table roots. Keep the 420 WU owner-sphere pad. | No horizon instance tax; on-glass batches stay. |
