...
- B8 trigger hook registered in `src/data/narrative.js` (`POST_SPINE_BEAT_CONTENT[8]`, `story_b8_helix_audit`); the playable Codex spine remains B0-B7.
...
### T5d-AUD-03 — claim (2026-07-08)
- Claimed BP-10.1 `PKT-AUD-03` from `detail/F_comms_audio_onboarding.md`.
