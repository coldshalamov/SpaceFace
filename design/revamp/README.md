...
| [`FRONTEND_REBOOT_AUDIT.md`](FRONTEND_REBOOT_AUDIT.md), [`HUD_THREE_ANCHOR.md`](HUD_THREE_ANCHOR.md), [`ONE_VOICE_CLOSEOUT.md`](ONE_VOICE_CLOSEOUT.md) | Dated surface inventory and reconciliation receipts. They do not authorize deleting useful HUD/contact surfaces or replacing the protected station UI. Current flight-HUD execution is [`../HUD_FLIGHT_ATTENTION.md`](../HUD_FLIGHT_ATTENTION.md). |
...
| [`FRONTEND_DIRECTION_AND_MENU_ARCHITECTURE.md`](FRONTEND_DIRECTION_AND_MENU_ARCHITECTURE.md) | 2026-08-14 direction for **screens, menus, in-flight access, and progression** — measured diagnosis, screen map, and ranked work order. Its §0 explicitly cedes the flight HUD to [`../HUD_FLIGHT_ATTENTION.md`](../HUD_FLIGHT_ATTENTION.md) and is not a second HUD spec. Lookable prototype: repo-root `_uilab.html`. |
