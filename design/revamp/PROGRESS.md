...
| T4b | BP-12 Causal Economy | 14 packets (`detail/E_salvage_economy_contracts.md`) — TOP 3 first: CAUSE_LEDGER_TOOLTIP, ECONOMY_BORN_MISSIONS, CONVOY_LOSS_INVESTIGATION | IN-FLIGHT 2026-07-06 | — | `check:causal-economy` | T4a | T4c |
