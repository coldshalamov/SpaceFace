...
| **B13 The player is never knocked around** | In ten minutes of ordinary flight (no rope, no fields, no deliberate ram), contact changes the player's velocity ≤ 2 times per minute and never by more than 10 % of cruise in one event, never changes the player's heading, and never produces visible jitter; a deliberate big event (a slam the player chose, a well the player flew into) may, and it must be legible. | **Flight bench MET 2026-09-05** — ten minutes at seed 4242: 1.0 knocks/min, largest 6.6 % of cruise, 0 heading changes. **Crucible 90s pool MET 2026-09-06** — nine cells × seeds 4242/8008, worst 2.00 knocks/min (Helios rope 8008), worst 10.0 % of cruise, 0 heading; a live rope holds the player against traffic. **Jitter MET** — strip at 0.614 of real time, 0/0/0 reversals over 2 contact windows | `feel.knock_budget`, `feel.knock_budget_10min`, crucible knock metrics + a normal-speed knock strip | **MET** `PQ-137.11` |
