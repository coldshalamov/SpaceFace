...
| B-lane-furniture | 6 Helios corridor props | near-done | CHECKPOINT 2026-08-18 | Helios POIs exist. Release build fails: no spacefaceAsset contract. Not wired. | Stamp contract + release, then add to PLACE_FILES |
