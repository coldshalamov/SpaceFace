...
| B-lane-furniture | 6 Helios corridor props | done | MERGE 2026-08-18 | Stamped, released, construction-repaired (no floating vanes/pads/bricks). Still panel 2/3 WIRE_ALL. Admitted to PLACE_FILES. Helios POIs already on the starter corridor now resolve. | Keep G1/G2/G4 open; do not treat untextured role paint as a closed surfacing pass |
