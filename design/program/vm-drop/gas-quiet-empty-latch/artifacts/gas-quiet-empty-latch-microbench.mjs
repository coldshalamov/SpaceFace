...
const ITERS = 200000;
const PAIRS = 13;
const worker = 'artifacts/gas-quiet-empty-latch-microbench-worker.mjs';
...
writeFileSync('artifacts/gas-quiet-empty-latch-microbench.json', JSON.stringify(out, null, 2));
