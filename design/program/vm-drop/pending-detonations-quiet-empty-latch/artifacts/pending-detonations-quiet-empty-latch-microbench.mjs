...
const ITERS = 400000;
const PAIRS = 13;
const worker = 'artifacts/pending-detonations-quiet-empty-latch-microbench-worker.mjs';
...
pairs.sort((x, y) => x - y);
const out = {
  name: 'pending-detonations-quiet-empty-latch',
  iters: ITERS,
  pairs: PAIRS,
...
writeFileSync('artifacts/pending-detonations-quiet-empty-latch-microbench.json', JSON.stringify(out, null, 2));
