"""Legal Mule chase stills on a CPU/llvmpipe VM.
...
# Mule collisionRadius from src/data/ships.js (18)
RADIUS = {
    "hornet": 16.0, "kestrel": 14.0, "hitch": 14.0, "drifter": 18.0,
    "ranger": 18.0, "ironback": 17.0, "pelican": 16.0, "mule": 18.0, "atlas": 30.0,
}
...
def main():
    ...
    scale, authored, target = apply_runtime_scale(meshes, RADIUS.get(ship, 18.0))
    meshes = visible_meshes()
