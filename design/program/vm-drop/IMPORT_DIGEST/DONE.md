...
Scratch `vm-work/hillclimb-20260924h` through #51; +#52 measured on stack
@ `92e36f2e8`.

Quiet stack inherits prior 45s profile shape (idle ~61%; soft-GPU fps ignored).

**Shipped this pass:**
- **#52 `asset-residency-diagnostics-cache`** — portable quiet
  `canonicalDiagnostics` **~794×** (80-asset quiet republish; emit/cacheSweep
  invalidate); focused residency **pass**.
