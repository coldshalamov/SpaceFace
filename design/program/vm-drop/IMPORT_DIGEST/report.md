# IMPORT_DIGEST report — 2026-09-24bi (post-import hillclimb)
...
through #101 @ `b72bc418c`; +#102 measured on stacked tip @ `09baafe61`. Profile
...
1. prepareFrame residual after #13+#44+#46+#47+#51–#58+#63+#65+#68+#71+#72+#73+#74+#75+#76+#77+#78+#79+#80+#81+#89+#90+#91+#92+#93+#94+#95+#96+#97+#98+#99+#100+#101+#102
   ...
   ~1.42–1.48×; emergent empty-assign/latch held ~1.22–1.46×).
