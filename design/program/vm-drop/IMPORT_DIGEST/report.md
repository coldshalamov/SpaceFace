# IMPORT_DIGEST report — 2026-09-24bj (post-import hillclimb)
...
through #102 @ `09baafe61`; +#103 measured on stacked tip @ `f5a2562bb`. Profile
...
1. prepareFrame residual after #13+#44+#46+#47+#51–#58+#63+#65+#68+#71+#72+#73+#74+#75+#76+#77+#78+#79+#80+#81+#89+#90+#91+#92+#93+#94+#95+#96+#97+#98+#99+#100+#101+#102+#103
   ...
   ~1.42–1.48×; emergent empty-assign/latch held ~1.22–1.46×; `_energyPlumeRelevant`
   probe cost when already quiet-hidden).
