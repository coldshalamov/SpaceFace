"""Legal Warden chase stills on a CPU/llvmpipe VM.
...
# Warden collisionRadius from src/data/ships.js
RADIUS = {
    "hornet": 16.0, "kestrel": 14.0, "hitch": 14.0, "drifter": 18.0,
    "ranger": 18.0, "ironback": 17.0, "bastion": 22.0, "atlas": 30.0, "warden": 26.0,
}
