...
| `G02` | `G01,F13` | Capture and restore `fresh-start` without support state. | New ignored artifact + fixture manifest update via integrator; save paths read-only. | New Game route, save schema, Continue, semantic fixture claims. |
