...
| `A08` | `A01,A05` | Signature model derives emissions from exposed geology, power, machinery, transport, and masking. | New pure signature kernel + site state. | Monotonic/exception contracts, deterministic aggregation. |
