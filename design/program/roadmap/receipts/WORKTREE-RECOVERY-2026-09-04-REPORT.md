...
|---|---|---|---|---|---|
| `wt-contact-v4` | `codex/contact-terrain-20260904-v1` | `0b7f91d6` | `DROP` | Commit `0b7f91d6` is in `master`. | Worktree removed; branch deleted. |
| `wt-flight-governor-v2` | `codex/flight-governor-20260904-v2` | `a9933691` | `DROP` | Commit `a9933691` is in `master`. | Worktree removed; branch deleted. |
| `wt-flight-v2` | `codex/contact-player-knock-20260904-v1` | `8198c0ed` | `DROP` | Cherry-picked to `master` as `a3bd740d` ("PQ-137.11: keep player contact from knocking the hull off its course"). | Worktree removed; branch deleted. |
| `wt-force` | `codex/force-law-20260904-v4` | `f420b9fb` | `DROP` | All 4 commits (`23e59447`, `ba4016af`, `4b267dd5`, `f420b9fb`) are in `master`. | Worktree removed; branch deleted. |
| `wt-world-patrol-v5` | `codex/force-weapons-20260904-v1` | `8f55489f` | `DROP` | Commit `8f55489f` is in `master`. | Worktree removed; branch deleted. |
| `wt-world-v2` | `codex/world-tail-fix-20260904-v2` | `904da058` | `DROP` | 0 commits ahead/behind `master` (identical tree). | Unlocked; worktree removed; branch deleted. |
