...
| B13 The player is never knocked around | contact knocks per minute on the player, verbs feel.knock_budget (worst of 1 run(s)): 2 events/min<br>largest single knock, fraction of cruise, verbs feel.knock_budget (worst of 1 run(s)): 0.056074 fraction<br>knock events that changed the player's heading (worst of 1 run(s)): 0 events | ≤ 2 contact knocks per minute; largest ≤ 10 % of cruise; zero heading changes; no visible jitter | — | verbs/feel.knock_budget/s4242 |
...
### verbs feel.knock_budget seed 4242 (run c4fe6bcd)
...
| knock budget on the player | 2/min, max 5.607409% of cruise, 0 heading changes | <= 2/min and <= 10% of cruise, never a heading change | not measured |
