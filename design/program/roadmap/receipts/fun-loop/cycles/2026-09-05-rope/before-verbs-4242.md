...
|---|---|---|---|---|
| B1 Earned speed is kept | release speed kept 5 s after letting go, hands off (worst of 1 run(s)): 1.000039 fraction | ≥ 99 % of exit speed 10 s later, hands off and forward held | — | verbs/feel.rope_swing_release/s4242 |
...
| B7 The rope is a rope | peak line stretch (worst of 1 run(s)): 0.163355 fraction<br>tangential speed kept 5 s after release (worst of 1 run(s)): 1.000039 fraction<br>peak stretch on a 100 WU line at 1.5x cruise: 0.163355 fraction<br>line held until commanded release: yes<br>tangential speed kept 5 s after release: 1.000039 fraction | stretch < 10 %; release keeps ≥ 95 % of tangential speed at 5 s | no | verbs/feel.rope_swing_release/s4242 |
...
- **B7 The rope is a rope** — Line break is not instrumented (the bench detaches the tether by design at release). authored 100 WU; peak line 116.336 WU before 122.86 WU/s; 5 s 122.86 WU/s
...
### verbs feel.rope_swing_release seed 4242 (run 07b6c679)

Bars this run feeds (FEEL_CONTRACT §B — pooled verdict for the whole receipt):

| bar | value(s) | target | met |
|---|---|---|---|
| B1 Earned speed is kept | release speed kept 5 s after letting go, hands off (worst of 1 run(s)): 1.000039 fraction | ≥ 99 % of exit speed 10 s later, hands off and forward held | — |
| B7 The rope is a rope | peak line stretch (worst of 1 run(s)): 0.163355 fraction<br>tangential speed kept 5 s after release (worst of 1 run(s)): 1.000039 fraction<br>peak stretch on a 100 WU line at 1.5x cruise: 0.163355 fraction<br>line held until commanded release: yes<br>tangential speed kept 5 s after release: 1.000039 fraction | stretch < 10 %; release keeps ≥ 95 % of tangential speed at 5 s | no |
