...
| PQ-050.02 Drifter chase C21 | code-work-coordinator | `bc-8188ad27-0dbf-5951-be0b-f48141e18378` | `cursor/pq050-02-drifter-chase-c21-8378` | WORKING | chase_form_v21: continuous plated shell (no extra hoops); midship hardware clusters; close field breakup | 2026-09-21 C21 start | all three cameras must stay TUBE_PADDLE NO; cage read must go |
| PQ-050.02 Drifter | code-work-coordinator | `bc-8188ad27-0dbf-5951-be0b-f48141e18378` | `cursor/pq050-02-drifter-chase-c21-8378` | WORKING (C21 attempt; C20 TUBE_PADDLE + nozzles keep; stop rib-cage) | continuous plated shell on the cleared diamond | 2026-09-21 C21 claim | undo if any camera flips TUBE_PADDLE YES |
