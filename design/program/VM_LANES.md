...
| PQ-050.02 Drifter chase C19 | code-work-coordinator | `bc-8188ad27-0dbf-5951-be0b-f48141e18378` | `cursor/pq050-02-drifter-chase-c19-8378` | WORKING | chase_form_v19: denser inter-hoop panels, midship value/hardware, circular aft nozzle | 2026-09-21 C19 start | all three cameras must stay TUBE_PADDLE NO |
| PQ-050.02 Drifter | code-work-coordinator | `bc-8188ad27-0dbf-5951-be0b-f48141e18378` | `cursor/pq050-02-drifter-chase-c19-8378` | WORKING (C19 attempt; C18 TUBE_PADDLE keep) | close C18 leftovers on the cleared diamond | 2026-09-21 C19 claim | undo if any camera flips TUBE_PADDLE YES |
