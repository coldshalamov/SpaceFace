...
|---|---|---|---|---|---|---|
| `PQ-050.03` Ranger chase C4 | grok-bot-box | `grok-bot-box` | `leaf/pq050-03-ranger-chase-c4-box` | **RESULT: REVISE** (CAGE_READ NO; TUBE_PADDLE NO; Hitch still wins D=144 massing/skin; parent unproven) | chase_form_v4a: remass bow + mid-hull, no new garnish; Hitch/Hornet/Drifter frozen | C5: Hitch formed-shell / skin still wins — not garnish |
