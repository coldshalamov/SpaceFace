...
| M3 | Origins, cohorts, Hunter intent, damage/death/recovery substantially built | Career origins green; focused damage/death/recovery route 23/23 | Natural damage/Game Over proven; a fresh natural Hunter recovery observation and three full 90-minute routes remain open | Damage/after-action images exist; no fresh recovery Browser/Electron claim | 0 recorded | NOT EXITED |
| M4 | Regional ecology/POI foundations built | Regional ecology 9/9 on authoritative runtime/reset order plus save/reload | Sparse/normal/crowded diversity routes open | Art/classification incomplete | 0 recorded | NOT EXITED |
...
- `npm run check:m2:seamless-world` — browser section completed, Electron websocket reset,
  process exited 1.
- `npm run check:m4:regional-ecology` — 9/9 on 2026-08-05; the obsolete registry/main source-text pins were replaced with the authoritative runtime and fresh-run orders.
- M3 focused recovery — 23/23 on 2026-08-05; a fresh natural Hunter Browser/Electron settlement remains unclaimed release evidence rather than unfinished production code.
