...
|---|---|---|---|---|
| Comprehensive LOD models & system pass: real whole-ship simplification, modular hull silhouettes, procedural geometry deflating box fallbacks, full LOD family wiring | antigravity-lod-pass | PUBLISHING | `scripts/build-wholeship-lod.mjs`, `src/render/visualFactory.js`, `assets/ships/parts/wholeships/`, `assets/ships/release/parts/wholeships/`, `assets/ships/render-packages/pilots.json`, `assets/ships/release/release_manifest.json`, `assets/ships/release/render-packages/`, `src/render/renderPackageManifest.js`, `test/perf-submit-lod-archetype.test.mjs`, `test/wholeship-lod-quality-all.test.mjs`, `design/program/NOW.md` | publishing exact pathspecs: whole-ship simplification, deflated box fallbacks, render packages |
...
| PQ-032.02 Deep Reach climax is a physical toy | grok-pq032-climax | IN PROGRESS | `src/story/campaign47a/embodiedMissions.js`, `src/systems/missions.js`, `src/data/missions.js`, `test/contract-47a-b7-deep-reach-operation.test.mjs`, `test/story-campaign47a-live.test.mjs` | tests green; review in flight |
...
| PQ-033.02 save-growth: bound ledger ramps + orphan hardening | zcode-wf-pq033-02-savegrowth | IN PROGRESS | `test/save-growth-dock-trade-flat.test.mjs`, `src/world/farActorTable.js`, `src/systems/npcJobsRuntime.js`, `src/systems/economy.js`, `src/systems/economyCycles.js`, `test/pq-033-02-far-row-budget.test.mjs`, `design/program/NOW.md` | focused flat-save test green, pathspec publish, row release |
