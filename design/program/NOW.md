...
baseCommit: 14bfa0380bf014107007d35d06d4971468754285
...
|---|---|---|---|---|
| PQ-137.09 chains go off (tether-two, primed ships, wells) | fable-orchestrator + opus implementer | MUTATING | src/systems/tetherGameplay.js, src/systems/fields.js, src/systems/swarmChain.js, src/systems/impulseCharges.js, test/chain-*.test.mjs, scripts/lib/bench/scenarios/feel.chain_*.mjs, design/program/roadmap/receipts/PQ-137-09-REPORT.md | review, commit by pathspec, push master |
| PQ-142.01 ship history: scars, repairs, recognition | fable-orchestrator + opus implementer | MUTATING | src/core/livingHull.js, src/systems/shipLedger.js, src/systems/barkDirector.js, src/systems/shipLedgerTemplates.js, save schema for scars (src/core/save*.js hunks the unit names), test/ship-history*.test.mjs, design/program/roadmap/receipts/PQ-142-01-REPORT.md | review, commit by pathspec, push master |
