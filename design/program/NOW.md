...
|---|---|---|---|---|
| PIC-11 claim — missing place does not appear as a published cube | inference-batch | PUBLISHING | `src/render/partsLibrary.js` | SHIPPED row in INFERENCE_IDEAS.md, pathspec commit |
