...
|---|---|---|---|---|
| PQ-033.02 autopilot dock wedges + restore-wait bound (soak evidence lane) | devin-pq033 | DONE 84f8c2016 | `src/systems/flightV3.js`, `test/station-docking-corridor.test.mjs`, `scripts/lib/releaseSoakProbe.mjs` | recorded, released |
