...
| PQ-033.02 save-growth: bound ledger ramps + orphan hardening | zcode-wf-pq033-02-savegrowth | IN PROGRESS | `test/save-growth-dock-trade-flat.test.mjs`, `src/world/farActorTable.js`, `src/systems/npcJobsRuntime.js`, `src/systems/world.js`, `design/program/NOW.md` | focused flat-save test green, pathspec publish, row release |
