...
| Finish-game orchestration | Cursor Grok orchestrator (`.codex/agent-checkpoints/ORCH-FINISH.json`) | MUTATING | `design/program/NOW.md` | PQ-029.03 occupational heads in flight after coupler hitch. Skip 174 HP theater. |
| PQ-029.03 NPCs use the heads | Cursor Grok orchestrator (`.codex/agent-checkpoints/PQ-029.03.json`) | MUTATING | `src/data/modules.js`, `src/systems/npcJobsRuntime.js`, `test/npc-jobs-runtime-occupational-heads.test.mjs` | tugs couple, salvors tractor, sweepers whip; headless proof, no Range, no capture |
