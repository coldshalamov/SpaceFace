...
|---|---|---|---|---|
| CI split: check-ci-report sharding + four parallel workflow jobs so a push reports green in < 15 min | fable-orchestrator + opus implementer | MUTATING | .github/workflows/check.yml, scripts/check-ci-report.mjs, test/check-ci-report.test.mjs, docs/VALIDATION_WORKFLOW.md (CI section) | review, commit by pathspec, push master |
...
| Captures lane: shipping-camera strips owed by PQ-137.03/.05/.06/.08/.09, PQ-138.00, PQ-139.03, PQ-139.05 (+ the chain_reaction tape) | fable-orchestrator + opus implementer | MUTATING | scripts/lib/bench/frameStripCapture.mjs (STRIP_SCENARIOS tapes only), design/program/roadmap/receipts/fun-loop/manifests/**, the eight receipts THE FRAMES rows only | review, commit by pathspec, push master |
...
| PARKED foreign hunk (another live session, the 13:21-13:48 frontend repair pass e86f4be8..81253f60, has uncommitted work in src/ui/uiRoot.js, styles/menu.css, styles/ui.css and .claude/launch.json; this thread never touches or commits them; captures must not photograph a dirty src/ui or styles tree) | other session | FOREIGN | src/ui/uiRoot.js, styles/menu.css, styles/ui.css, .claude/launch.json | that session commits or discards its own work |
