...
| INFERENCE 20 — look-then-rotate grunt pass | devin-inference-20 | IN PROGRESS 2026-09-25 | units 1-8 landed + review tails; currently: synthesis→implement loop for units 9-13 (onboarding rail, bar voice, salvage POI, faction barks) | 20 complete production units, rotating kinds, each committed with pathspec + inference-record |
