...
|---|---|---|---|---|
| INFERENCE WF-14 asteroid scan glyph tells the truth | inference-scan-glyph | MUTATING | `src/data/mining.js`, `src/systems/scanner.js`, `src/ui/galaxyMap.js`, `src/ui/screens/localmap.js`, `src/careers/origins/prospectorOriginAppraisal.js`, `test/asteroid-scan-glyph.test.mjs`, `design/program/NOW.md` | prove the six rock types, commit, record |
