...
|---|---|---|---|---|
| Living Adventure: Choir relief crew | astra-choir | IN PROGRESS 2026-09-25 | `src/systems/uniqueWrecks.js`, `src/systems/choirReliefBerth.js`, `src/data/uniqueWrecks.js`, `test/living-adventure-choir.test.mjs`; checkpoint `.codex/agent-checkpoints/LIVING-ADVENTURE-CHOIR.json` | repair crew, durable salvage consequences, focused runtime verification |
| Living Adventure: a continuing Helios ore shift | codex-living-adventure | IN PROGRESS 2026-09-25 | `src/systems/traffic.js`, `src/systems/npcJobsRuntime.js`, `src/systems/mining.js`, `test/living-adventure-shift.test.mjs`, `test/inference-miner-shift.test.mjs`; checkpoint `.codex/agent-checkpoints/LIVING-ADVENTURE-SHIFT.json` | finite seams feed the ore barge, delivery and interruption; review and publish |
