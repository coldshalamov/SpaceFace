...
|---|---|---|---|---|
| INFERENCE WF-05 small concussion cannon physical displacement tool | antigravity-inference | DONE | `src/data/weapons.js`, `src/data/tech.js`, `src/ui/sandbox/sandboxSetup.js`, `test/concussion-cannon-s.test.mjs`, `design/program/NOW.md` | recorded, released — S-slot concussion cannon (wpn_concussion_cannon_s): 520 impulse, 35 tumble, trades raw damage for physical shove on light hulls (32.5 wu/s on Wasp), unlocks via tech_kinetic_drivers and sandbox, 6/6 tests green |
| INFERENCE WF-13 fuel warns before the tank is empty | inference-fuel-warn | MUTATING | `src/ui/fuelReserveWarning.js`, `src/ui/hud.js`, `test/fuel-reserve-warning.test.mjs`, `design/program/NOW.md` | prove the crossing, commit, record |
