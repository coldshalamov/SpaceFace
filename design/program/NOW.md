...
|---|---|---|---|---|
| PQ-033.02 autopilot dock wedges + restore-wait bound (soak evidence lane) | devin-pq033 | DONE 84f8c2016, afaeaac6d | `src/systems/flightV3.js`, `src/data/collisionProxyManifests.js`, `test/station-docking-corridor.test.mjs`, `scripts/lib/releaseSoakProbe.mjs` | recorded, released — browser soak 8/8 cycles dock+save+restore+trade clean, context-loss recovered |
