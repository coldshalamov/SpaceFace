...
- Accessibility: ensure keyboard navigation works for every modal (tab order, focus trap inside active screen, ESC always escapes) so required PC/browser flows are not mouse-trapped.
