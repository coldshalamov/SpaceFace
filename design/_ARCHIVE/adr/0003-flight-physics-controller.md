# ADR-0003: Flight Physics Controller (Superseded)
...
> (`src/core/gameState.js`, force-stamped during save normalization in `src/save/saveSystem.js`).
...
> legacy compatibility shim imported by `src/systems/aiPorts.js` and pinned by compatibility checks.
> See root `AGENTS.md` (live-backend routing) and `design/spec3/SPEC3-F3-flight-physics-feel.md`
...
## References
- `design/spec3/SPEC3-F3-flight-physics-feel.md`
