> ⚠ ARCHIVED — UNMANAGED DRIFT per AGENTS.md §4.
> This doc is NOT a live spec. It was moved here because it contradicts the active
> authority chain (ARCHITECTURE.md > GDD_2_0.md > spec2/00_MASTER_TASTE.md > spec3/F8-F10).
> Specifically: AGENTS.md §6 forbids visor/cockpit motifs; 00_MASTER_TASTE §3 locks the
> visual tokens. Do NOT implement from this doc. Live UI authority:
>   - design/spec2/06_UI_IDENTITY.md
>   - design/spec3/SPEC3-F8-graphics-visuals.md
>   - design/spec3/SPEC3-F10-ux-meta-tastemaster.md
>   - design/revamp/FRONTEND_REBOOT_AUDIT.md (surface inventory)
> Archived 2026-07-08.
