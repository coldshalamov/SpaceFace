...
| [`NEXT_JOBS.md`](./NEXT_JOBS.md) | **What to build next.** The ten things that most inhibit the player's experience, measured rather than asserted, and ten sequenced jobs across short/medium/long horizons — each naming the A-list pattern it borrows, what the player gets, and what it costs. Read this to pick up work. |
