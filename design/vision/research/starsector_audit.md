...
> This uncited draft is retained as a hypothesis and seed catalogue. Its counts, statistics, completeness labels, and individual lore claims are not evidence. Use `design/depth-program/research/verified/starsector.md` for sourced findings and `design/depth-program/research/SALVAGE_NOTES.md` for the salvage policy. This file is not implementation authority.
