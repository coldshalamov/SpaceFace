...
| 2 — Seamless world | Global coordinates, floating origin, streamed live bubble, 24 persistent regions, continuous free-flight/lane/gate travel, one map, and save migration. | Complete — commits `eed065ae`, `f4ba6a91`, `a4cc2e8c`, `228ce7b0`, `dc627198`, and `f9dab574`; 154/154 focused contracts plus continuous-handoff, full-field sector-embodiment, drone retention, map-cutover, 24-region graph, and deterministic save/reload floors pass. Browser/Electron parity receipt: `.devshots/m2-floating-origin/m2-seamless-world.json`. |
...
| 4 — Living-galaxy diversity | Distinct regional ecology, six POI behavior families, deterministic encounter fingerprints, solvable causal contracts, persistent aftermath. | In implementation — six deterministic POI behavior grammars retain stable zone-bound aftermath (`a7021280`). Regional ecology catalog+adapters now cover all 24 regions with 7 pairwise-distinguishable macro-families, unique fingerprints, hazard/faction/POI dimensions, durable aftermath deltas, and live seams into traffic/world yield/encounter weights/law security; named gate `npm run check:m4:regional-ecology` passes (9/9 unit + seam proofs). Station/outpost and Helios civilian slices landed. Ashline `5ae73146` remains HOLD/unwired. Accepted art and held-out player-route acceptance remain open. |
...
| 6 — Presentation/release | Independently accepted art/audio, browser/Electron parity, accessibility, save/packaging soak, and quality-preserving performance floors. | In implementation — release soak, corrupt-save, packaging, audio, performance instrumentation, and the evidence-bound six-shot/60-second WebM capture pipeline landed; `8e849a01`, 4/4 capture-contract tests, and the no-browser self-test pass. Commit `4a6b3f56` accepts the production Wasp visual family through runtime routing, New Game → Shipyard → Undock → save/Continue persistence, and reviewed full/LOD evidence. Launch policy and asset reachability are green at the 2026-07-14 checkpoint. Store capture is still absent. The latest recorded crowded-flight artifact is red at 49.4 ms p95 with 75 hitches; quality-preserving performance work, complete localization, browser/Electron capture parity, and five-wave platform acceptance remain open. |
