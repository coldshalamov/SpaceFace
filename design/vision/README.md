# SpaceFace Vision Pack — product framing and Alpha scope

**Created:** 2026-07-09  
**Purpose:** Route product-framing and Alpha-scope questions without competing with
`design/program/`, which is the sole whole-program status and pickup surface.
...
| ★ current | [`ALPHA_PROGRAM.md`](./ALPHA_PROGRAM.md) | **Current product-sprint scope/order authority.** Locked solo-alpha scope, milestone order, task boundaries, and evidence contract. `design/program/**` alone owns cross-program status. |
...
| ★ method | [`INFERENCE_CONVERGENCE_METHOD.md`](./INFERENCE_CONVERGENCE_METHOD.md) | **Durable supporting production method.** Diagnose ordinary-player truth, compare alternatives, cut weak ideas, review causal defects, and compose before multiplying. It never admits work or grants acceptance. |
...
| optional | [`OVERNIGHT_GOAL.md`](./OVERNIGHT_GOAL.md) | Explicitly activated overnight procedure with best-effort delivery and handoff. Not default authority. |
| optional | [`OVERNIGHT_GOAL_STRICT.md`](./OVERNIGHT_GOAL_STRICT.md) | Explicitly activated extended overnight procedure. Its process rules do not apply to ordinary tasks. |
...
### Optional overnight procedures

| You want… | Paste |
|---|---|
| Best-effort bounded run + honest handoff | `OVERNIGHT_GOAL.md` |
| Extended run with broader acceptance coverage | `OVERNIGHT_GOAL_STRICT.md` |

Activate either procedure explicitly. On return, use its `WAKE_REPORT.md` as evidence, then reconcile
real completion and remaining work into `design/program/`; scores and ritual completion do not decide quality.
...
ARCHITECTURE.md (technical contract)
  ...
  > design/vision/INFERENCE_CONVERGENCE_METHOD.md ← SUPPORTING METHOD; NO CLAIM OR ACCEPTANCE
  ...
  > design/CURRENT_BUILD_STATUS.md · BUILD_PLAN_2_0.md · graphics-sprints/*  ← historical / optional lane ops
```
...
| `design/graphics-sprints/` | Optional explicitly activated asset orchestration; verify live Blender/process ownership rather than treating a marker as permanent reservation |
...
## One-line product pitch (current framing reference)
