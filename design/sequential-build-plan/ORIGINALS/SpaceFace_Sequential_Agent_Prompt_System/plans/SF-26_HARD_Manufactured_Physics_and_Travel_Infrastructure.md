...
recommended_agent_profile: "Strong systems/world agent plus frontend/vision agent"
depends_on: ["SF-06", "SF-25"]
roadmap_alignment: "Built gravity/travel, A15/W17, Atlas physical lanes, progression/endgame"
prompt_system_version: "1.0"
terminal_gate: "ready-for-review with receipt; global completion remains lead-owned"
---

# SF-26 — [HARD][FULLSTACK][FRONTEND-HARD][VISION-YES] Manufactured Physics and Travel Infrastructure

<agent_assignment>
  <role>Strong systems/world agent plus frontend/vision agent</role>
...
<mission>
Asteroid/claim production can manufacture and place one permanent physics/travel infrastructure type that changes a real route—such as an artificial sling anchor or acceleration ring—plus one support structure such as cargo catcher, beacon, or sensor relay.
</mission>
...
<sequence_position>
  <prompt_id>SF-26</prompt_id>
  <declared_dependencies>SF-06, SF-25</declared_dependencies>
  <roadmap_alignment>Built gravity/travel, A15/W17, Atlas physical lanes, progression/endgame</roadmap_alignment>
...
<problem>
Automation needs a purpose beyond wealth and DPS. The Atlas/travel system and physics systems already suggest routes, Travel Burn, lanes, anchors, and logistics, but the player cannot yet manufacture infrastructure that rewrites the geometry or capability of the world.
</problem>
...
This is the progression thesis in one build: mine manually, automate production, fabricate machinery, place it in space, and make future travel/traffic visibly different. The player is not buying convenience; they are building the galaxy’s roads.
</why_this_is_cool_and_worth_building>
...
<scope>
  ...
  <deliverable>Audit current Travel Burn/lane hooks, Atlas route graph, place/claim construction, industrial fabrication, Mass Seed/field/course systems, traffic jobs, save/global coordinates, and ownership/faction law.</deliverable>
  <deliverable>Select one primary permanent infrastructure vertical slice: artificial sling anchor, acceleration ring, or equivalent physics route node. Select one smaller support type: cargo catcher, navigation beacon, sensor/market relay, or refueling pylon.</deliverable>
  <deliverable>Define fabrication recipes/prerequisites from the industrial claim and exact construction/deployment receipts.</deliverable>
  <deliverable>Implement placement policy at authored nodes or bounded player-selected zones with preview, collision/clearance, ownership/law, cancellation/refund policy, and stable global coordinates.</deliverable>
  <deliverable>Integrate primary infrastructure with actual route planning, target acquisition, course prediction/validation, Travel Burn/velocity semantics, player traversal, and NPC/hauler route use.</deliverable>
  <deliverable>Integrate support infrastructure with one concrete system capability.</deliverable>
  <deliverable>Author visible construction stages, activation, operation, traffic response, damage/disable/repair policy, map/ledger identity, and save/Continue.</deliverable>
  <deliverable>Measure route before/after: travel time, reachable pocket, traffic flow, or resource risk. Do not merely add a stat modifier.</deliverable>
  </mandatory_deliverables>
  <explicit_non_goals>
  <non_goal>No full player-built lane network or wormhole system.</non_goal>
  <non_goal>No free placement anywhere without collision/route validation.</non_goal>
  <non_goal>No passive percentage buff hidden in map data.</non_goal>
  <non_goal>No planetary engineering megastructure.</non_goal>
  </explicit_non_goals>
</scope>
...
Use these research anchors as starting points, not brittle file instructions:
  <anchor>Travel Burn/physical lane/Atlas route contracts, SF-06 course, SF-25 production, World Site construction.</anchor>
  <anchor>Global coordinates/place registration, NPC jobs, ownership/law, save and map/ledger.</anchor>
...
<implementation_direction>
  <direction>Use stable route-node/edge records and physical world entities sharing one identity.</direction>
  <direction>Course/route compiler validates geometry and recovery windows before activation.</direction>
  <direction>NPC routes consume the same infrastructure eligibility as player routes with class/policy differences.</direction>
  <direction>Construction uses World Site stages and current ownership/economy intents.</direction>
  <direction>Disabled infrastructure changes route state explicitly and offers recovery, not silent teleport failure.</direction>
</implementation_direction>

<acceptance_contract>
  <criterion>Industrial output fabricates the infrastructure through exact, nonduplicated receipts.</criterion>
  <criterion>Player places/builds/activates it through a normal route and it is physically visible/solid/targetable according to policy.</criterion>
  <criterion>A measured route or reachable capability changes in the world and Atlas; player and at least one NPC job can use it.</criterion>
  <criterion>Save/Continue and leave/return preserve placement/stage/route identity.</criterion>
  <criterion>Damage/disable/recovery does not strand the player without an alternate path.</criterion>
  <criterion>Browser/Electron, map, visual, performance, and accessibility evidence pass.</criterion>
...
The implementation fails review if any of the following occur:
  <failure>Menu purchase applying `travelTime *= 0.8`.</failure>
  <failure>Decorative ring unrelated to route physics.</failure>
  <failure>Route graph edge with no world structure.</failure>
  <failure>World structure with no Atlas/navigation effect.</failure>
  <failure>Free instant construction with no production relationship.</failure>
  <failure>NPCs teleporting through it while player flies physically.</failure>
...
Task-specific required verification:
  <verification>Recipe/placement/clearance/stage/route-node/course/save tests.</verification>
  <verification>Before/after player and NPC route receipts, failure/recovery.</verification>
  <verification>Map/world same-identity captures, normal browser/Electron traversal, performance and visual review.</verification>
</verification_plan>
...
Write this receipt shape to `receipts/SF-26.yaml`:
...
- Write the machine-readable receipt at `receipts/SF-26.yaml`.
...
- [ ] Receipt written to `receipts/SF-26.yaml`.
