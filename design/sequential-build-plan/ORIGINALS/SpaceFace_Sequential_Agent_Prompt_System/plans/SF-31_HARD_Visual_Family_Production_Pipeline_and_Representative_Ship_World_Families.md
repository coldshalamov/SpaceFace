...
recommended_agent_profile: "Strongest available frontend/vision/3D asset agent (Fable-class or equivalent); backend-only agent must not sign acceptance"
depends_on: ["SF-01", "SF-15", "SF-21", "SF-30"]
roadmap_alignment: "M0 calibration/asset integrity, M1/M4 visual families, L1/PR1/PR2/S1\u2013S4/M5 coverage"
prompt_system_version: "1.0"
terminal_gate: "ready-for-review with receipt; global completion remains lead-owned"
---

# SF-31 — [HARD][FRONTEND][FRONTEND-HARD][VISION-YES] Visual-Family Production Pipeline and Representative Ship/World Families

<agent_assignment>
  <role>Strongest available frontend/vision/3D asset agent (Fable-class or equivalent); backend-only agent must not sign acceptance</role>
...
<mission>
The repository has a repeatable asset-family pipeline and a small accepted wave of visually and behaviorally distinct ship/world families, judged in the normal game camera with exact runtime identity, not by isolated renders or color swaps.
</mission>
...
<sequence_position>
  <prompt_id>SF-31</prompt_id>
  <declared_dependencies>SF-01, SF-15, SF-21, SF-30</declared_dependencies>
  <roadmap_alignment>M0 calibration/asset integrity, M1/M4 visual families, L1/PR1/PR2/S1–S4/M5 coverage</roadmap_alignment>
...
<problem>
The current graphics checkpoint established valuable foundations, but the world still risks repeated silhouettes, materials, and behavior. Agents often respond to “advanced graphics” with noise, bloom, primitive geometry, or cartoony generated assets. A disciplined foundry must connect source, semantic roles, LOD, collision, behavior, runtime admission, and game-camera evidence.
</problem>
...
Distinct miners, haulers, patrols, outlaw craft, props, stations, and landmarks make jobs and factions legible before the HUD says what they are. A reusable pipeline lets future agents expand quality without starting over or hiding weak geometry under effects.
</why_this_is_cool_and_worth_building>
...
<scope>
  ...
  <deliverable>Audit the long-term graphics overhaul, current asset receipts/classifications, foundry/export/KTX2/LOD/admission/stability tools, live families, missing coverage, and current normal-route visual defects.</deliverable>
  <deliverable>Calibrate available generation/model/Blender/review workflows against a professional bar using retained prompts/sources/outputs and explicit accept/reject reasons.</deliverable>
  <deliverable>Define or harden declarative family specs for silhouette/function, chassis/attachments, semantic materials, palette/livery eligibility, sockets, collision/interaction envelope, LOD/HLOD, motion/VFX/audio, behavior carrier, provenance, and performance budget.</deliverable>
  <deliverable>Produce and integrate one bounded representative wave—e.g. miner, hauler, patrol/interceptor, outlaw/scavenger, 3–5 world props or route structures—chosen to support already implemented jobs/sectors.</deliverable>
  <deliverable>Use authored Blender GLB/KTX2 assets where silhouette/construction matters; procedural only for bounded variation/transient presentation.</deliverable>
  <deliverable>Implement distinct runtime motion/behavior/attachment cues and faction/law identity beyond color swaps.</deliverable>
  <deliverable>Validate resolve→prepare→admit, no placeholder, stable transform, bounds/sockets/proxies, material roles, asset manifests, disposal/residency, and browser/Electron parity.</deliverable>
  <deliverable>Create matched close/default/far/motion/crowded captures and an acceptance gallery with revision/settings/artifact hashes; record rejected candidates, not only successes.</deliverable>
  </mandatory_deliverables>
  <explicit_non_goals>
  <non_goal>No fleet-wide remaster or all five capitals.</non_goal>
  <non_goal>No replacement of accepted Kestrel/Helios without measured superior evidence.</non_goal>
  <non_goal>No generic generated asset dump.</non_goal>
  <non_goal>No post-processing used to conceal silhouette/material defects.</non_goal>
  </explicit_non_goals>
</scope>
...
Use these research anchors as starting points, not brittle file instructions:
  <anchor>Long-term graphics overhaul/checkpoint, asset receipts/classifications/foundry, runtime parts/renderer/background.</anchor>
  <anchor>NPC jobs/sector postcard and current ship/station/place/prop family plans.</anchor>
...
<implementation_direction>
  <direction>Judge macro/meso/micro hierarchy at actual gameplay distance; use bevels, authored UVs/maps, roughness variation, semantic materials, functional sockets/attachments.</direction>
  <direction>Keep native color preservation and bounded palette channels; livery is not identity by itself.</direction>
  <direction>Batch/instance/LOD based on measured draw/residency/frame benefit while preserving stable transforms and roles.</direction>
  <direction>Each family must have a natural producer/carrier and behavior route before visual acceptance.</direction>
  <direction>Use vision-capable independent review; self-score from the generating agent is insufficient.</direction>
</implementation_direction>

<acceptance_contract>
  <criterion>Foundry/calibration records show which workflows reliably meet the bar and which are rejected.</criterion>
  <criterion>Representative families are distinguishable by silhouette, construction, motion, job behavior, materials, and effects at gameplay zoom.</criterion>
  <criterion>Exact authored assets are admitted before interaction; no visible fallback swap.</criterion>
  <criterion>LOD/material/proxy/socket identity remains stable through motion, sector transitions, Continue, and context recovery.</criterion>
  <criterion>Browser/Electron matched captures and crowded performance/residency meet declared budgets.</criterion>
  <criterion>Provenance/classification/manifest/license records are complete.</criterion>
...
The implementation fails review if any of the following occur:
  <failure>Color-swapped same ship called a new family.</failure>
  <failure>Primitive boxes/spheres with bloom.</failure>
  <failure>Cartoon/pulp aesthetic by accident.</failure>
  <failure>Blender turntable as sole acceptance.</failure>
  <failure>Deleting LODs or lowering quality to pass performance.</failure>
  <failure>Assets with no natural carrier or behavior.</failure>
...
Task-specific required verification:
  <verification>Asset/foundry/export/manifest/classification/admission/stability/disposal checks.</verification>
  <verification>Normal job/sector routes in browser/Electron at sparse/normal/crowded loads.</verification>
  <verification>Independent vision review and retained before/after/rejected gallery.</verification>
  <verification>GPU/draw/residency/frame/memory profiles.</verification>
</verification_plan>
...
Write this receipt shape to `receipts/SF-31.yaml`:
...
- Write the machine-readable receipt at `receipts/SF-31.yaml`.
...
- [ ] Receipt written to `receipts/SF-31.yaml`.
