...
| [`graphics-sprints/`](./graphics-sprints/00_ORCHESTRATION.md) | Concurrent graphics/Blender execution and ownership lanes | **ACTIVE LANE OPS** | Graphics controller; quality/status rolls into `program/` |
