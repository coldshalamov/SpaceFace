...
const PROFILES = Object.freeze({
  engine_ion_small:   Object.freeze({ station: 0.41, halfSpan: 0.40, bell: 0.058, segments: 12, length: 0.72, width: 0.78, flow: 2.7, coherence: 0.46 }),
  engine_ion_twin:    Object.freeze({ station: 0.40, halfSpan: 0.46, bell: 0.054, segments: 12, length: 0.80, width: 0.73, flow: 3.0, coherence: 0.50 }),
  engine_industrial:  Object.freeze({ station: 0.36, halfSpan: 0.44, bell: 0.072, segments: 10, length: 0.62, width: 0.93, flow: 1.8, coherence: 0.34 }),
  engine_resonator:   Object.freeze({ station: 0.42, halfSpan: 0.44, bell: 0.060, segments: 6, length: 0.77, width: 0.80, flow: 3.2, coherence: 0.42 }),
  engine_vector:      Object.freeze({ station: 0.43, halfSpan: 0.45, bell: 0.048, segments: 8, length: 0.81, width: 0.66, flow: 3.5, coherence: 0.55 }),
  engine_plasma_ring: Object.freeze({ station: 0.39, halfSpan: 0.45, bell: 0.066, segments: 14, length: 0.73, width: 0.85, flow: 2.4, coherence: 0.38 }),
});
