...
export const pauseScreen = {
  ...
  mount(rootEl, ctx) {
    ...
    // and what Task B §1.4 lists. The approved title frame is the grammar this screen borrows: no
    // boxes, words over the world, ONE lit row plate following focus (styles/kit.css §PAUSE). Every
