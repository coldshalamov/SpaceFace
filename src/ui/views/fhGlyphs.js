...
//   weapon icon-munitions   line  icon-line     well  icon-well   cone icon-cone   rig icon-utility
...
const RAW = Object.freeze({
  ...
  line: `<path fill="currentColor" fill-rule="evenodd" d="M2.20,18.80a3.00,3.00 0 1 0 6.00,0a3.00,3.00 0 1 0 -6.00,0ZM15.80,5.20a3.00,3.00 0 1 0 6.00,0a3.00,3.00 0 1 0 -6.00,0ZM5.20,19.65 L19.65,5.20 L18.80,4.35 L4.35,18.80Z"/><path fill="currentColor" class="accent" d="M9.80,12.00a2.20,2.20 0 1 0 4.40,0a2.20,2.20 0 1 0 -4.40,0Z"/>`,
