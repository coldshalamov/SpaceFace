...
${M} .sx-mkt-search { ${PLAIN} border-bottom:1px solid rgb(${BONE} / .24) !important; border-radius:0 !important; padding:7px 0 !important;
  min-height:0 !important; height:auto !important; font-size:13px !important; color:rgb(248 244 234) !important; margin-bottom:10px !important; }
...
${M} .sx-mkt-table { ${PLAIN} border-collapse:separate !important; border-spacing:0 !important; }
...
${M} .sx-mkt-row { outline:none !important; cursor:pointer; }
...
${M} .sx-mkt-row.is-active .sx-mkt-row__name::after { content:""; position:absolute; left:1px; top:50%; width:12px; height:12px; margin-top:-6px;
  clip-path:polygon(0 0, 100% 50%, 0 100%); background:rgb(248 244 234); }
...
${M} .sx-mkt-row .sx-mkt-row__tr { font-size:10.5px !important; margin-left:6px; color:rgb(${BONE} / .5) !important; }
${M} .sx-mkt-row .sx-mkt-row__tr.is-up { color:rgb(${BONE} / .85) !important; }
${M} .sx-mkt-row .sx-mkt-row__tr.is-down { color:rgb(${BONE} / .6) !important; }
...
${M} .sx-mkt-row .of-commodity-icon, ${M} .sx-mkt-row .sx-mkt-row__commodity { margin-right:8px; opacity:.85; }
...
${M} .sx-mkt-readouts__item--buy .sx-mkt-readouts__mark { background:rgb(248 244 234) !important; }
${M} .sx-mkt-readouts__item--sell .sx-mkt-readouts__mark { background:rgb(${BONE} / .5) !important; }
...
${M} .sx-trade { ${PLAIN} padding:0 !important; display:grid !important;
  grid-template-columns:168px minmax(0, 1fr); grid-template-rows:auto auto auto auto;
  grid-template-areas:"dial total" "dial note" "dial verb" "dial breakdown"; column-gap:clamp(20px, 2.4vw, 44px); row-gap:6px; align-items:center; align-content:center; }
${M} .sx-trade > .sx-qty { grid-area:dial; position:relative; display:block !important; width:168px; height:176px; ${PLAIN} padding:0 !important; }
${M} .sx-qty .orr-qdial { position:absolute; left:9px; top:0; width:150px; height:150px; overflow:visible; cursor:grab; touch-action:none; }
...
${M} .orr-qdial__end { font-family:var(--dp-face-label, "Archivo"); font-stretch:112%; font-weight:650; font-size:9px; letter-spacing:.08em; fill:rgb(${BONE} / .55); }
${M} .sx-qty .sx-qty__k { position:absolute; left:9px; width:150px; top:44px; text-align:center; margin:0 !important; padding:0 !important;
...
${M} .sx-qty .sx-qty__in { position:absolute !important; left:34px; width:100px !important; top:58px; height:40px !important; margin:0 !important; padding:0 !important;
  ${PLAIN} border-radius:0 !important; text-align:center; font-family:var(--dp-face-display, "Archivo") !important; font-stretch:100%;
  font-variation-settings:"wdth" 100, "wght" 560 !important; font-size:34px !important; line-height:40px !important; color:rgb(248 244 234) !important;
...
${M} .sx-qty .sx-qty__words { position:absolute !important; left:0; right:0; top:152px; display:flex !important; justify-content:space-between !important;
...
${M} .sx-qty :is(.sx-qty__b, .sx-qty__max) { ${PLAIN} ${LABEL} min-height:0 !important; min-width:0 !important; height:auto !important; padding:3px 2px !important;
  font-size:10px !important; letter-spacing:.18em !important; color:rgb(${BONE} / .7) !important; }
...
${M} .sx-trade__go[data-go]:disabled { color:rgb(${BONE} / .36) !important; cursor:default; }
...
${M} .sx-trade__go:not([data-go])::after { content:"  ›" !important; display:inline !important; position:static !important; width:auto !important; height:auto !important;
...
${M} .sx-mkt__decision { margin-top:14px; flex:0 0 auto !important; }
${M} .sx-mkt__analysis { min-height:0; }
${M} .sx-decision { ${PLAIN} padding:0 !important; margin:0 !important; display:flex !important; flex-direction:row !important; flex-wrap:wrap !important;
  align-items:baseline !important; gap:4px 26px !important; min-height:0 !important; height:auto !important; }
${M} .sx-decision > .k-sentence { margin:0 !important; color:rgb(${BONE} / .78) !important; font-size:13px !important; flex:1 1 100% !important; }
...
${M} .sx-decision__opt .k-row__name { ${LABEL} font-size:11px !important; letter-spacing:.16em !important; color:rgb(248 244 234) !important; }
...
@media (max-height:800px) {
  ${M} .sx-mkt__stage { display:grid !important; grid-template-columns:minmax(0, 1fr) 232px; grid-template-rows:minmax(0, 1fr) auto; column-gap:28px; }
  ...
  ${M} .sx-mkt__decision { grid-column:1; grid-row:2; margin-top:8px; }
