...
export const PRODUCTION_INIT_ORDER = Object.freeze([
  ...
  'aiPorts', 'tumbleStates', 'collisionConsequences', 'heavyPartsRuntime', 'capitalRuntime', 'aiEncounter', 'actions', 'flightSlot',
  'cruise', 'weapons', 'countermeasures', 'impulseCharges', 'mines', 'massSeed',
  'uniqueLootAbilities', 'fields', 'environmentalMachinery', 'anomalyRuntime', 'planetRuntime', 'mediumEnemyRuntime', 'combat', 'combatOutcome', 'aftermathWrecks',
...
export const PRODUCTION_UPDATE_ORDER = Object.freeze([
  ...
  'collisionConsequences', 'heavyPartsRuntime', 'capitalRuntime', 'weapons', 'countermeasures', 'impulseCharges', 'mines', 'massSeed',
  'uniqueLootAbilities', 'dockingCorridor', 'environmentalMachinery', 'anomalyRuntime', 'fields', 'planetRuntime', 'physics', 'mediumEnemyRuntime', 'combat',
