...
export const CAMPAIGN_BEATS = Object.freeze([
  ...
  },
  {
    ...
    id: 'first_blood',
    title: 'First Blood',
    objective: 'Identify the marked vessel, then choose force or massline custody.',
    steps: Object.freeze([
      Object.freeze({
        id: 'identify',
        order: 0,
        accept: Object.freeze(['scan:completed', 'entity:killed']),
        label: 'Scan target / recover wreck registry',
      }),
      Object.freeze({
        id: 'resolve',
        order: 1,
        accept: Object.freeze(['tether:reel', 'entity:killed']),
        label: 'Secure custody / close by force',
        requiresPrior: Object.freeze(['identify']),
      }),
    ]),
    observeOnly: false,
