...
export const CAMPAIGN_BEATS = Object.freeze([
  ...
  },
  {
    ...
    id: 'honest_work',
    title: 'Honest Work',
    objective: 'Knock the variance tower — wrecking-ball contract.',
    headlineVerb: 'knock',
    setPiece: 'wrecking-ball contract',
    steps: Object.freeze([
      Object.freeze({
        id: 'knock',
        order: 0,
        accept: Object.freeze(['mission:completed']),
        label: 'Knock the tower down',
      }),
    ]),
    observeOnly: false,
    liveMissionType: 'demolition',
    introduces: 'wrecking_ball',
    ...
    recovery: Object.freeze({
      ...
      line: 'The tower still stands. Knock it down.',
    }),
  },
  {
    beat: 2,
    id: 'first_blood',
    title: 'First Blood',
    objective: 'Pull the life pods out under fire.',
    headlineVerb: 'pull',
    setPiece: 'pod rescue under fire',
    steps: Object.freeze([
      Object.freeze({
        id: 'pull',
        order: 0,
        accept: Object.freeze(['mission:completed']),
        label: 'Pull the pods out',
      }),
    ]),
    observeOnly: false,
    liveMissionType: 'rescue_under_fire',
    introduces: 'pod_rescue',
    ...
    recovery: Object.freeze({
      ...
      line: 'Pods still drift. Pull them out.',
    }),
  },
  {
    beat: 3,
    id: 'bigger_boat',
    title: 'Bigger Boat',
    objective: 'Tow the slag core the long way into the yard.',
    headlineVerb: 'tow',
    setPiece: 'long tow',
    steps: Object.freeze([
      Object.freeze({
        ...
        order: 0,
        accept: Object.freeze(['mission:completed']),
        label: 'Tow the slag core',
      }),
    ]),
    observeOnly: false,
    liveMissionType: 'tow_recovery',
    introduces: 'long_tow',
    rewardDoc: Object.freeze({ credits: 1000, reason: 'story:beat:3', rep: Object.freeze([]) }),
    next: 4,
    recovery: Object.freeze({
      rearmOn: Object.freeze(['dock:docked', 'mission:failed']),
      line: 'The core still waits. Tow it in.',
    }),
  },
  {
    beat: 4,
