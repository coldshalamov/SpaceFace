  ...
  entries: [
    ...
    },
    {
      ...
      sourceBehaviors: [
        ...
        {
          id: 'cathedral_carrier', sourceId: 'wreck_cathedral', kind: 'ident',
          ident: { id: 'cathedral_ident', text: 'VIGILANT MEMORIAL: NINE HOURS HELD.' },
        },
        {
          id: 'candle_carrier', sourceId: 'candle_fleet', kind: 'ident',
          ident: { id: 'candle_ident', text: 'CANDLE FLEET: TWENTY-FOUR FLAMES.' },
        },
        {
          id: 'charon_carrier', sourceId: 'lung_of_charon', kind: 'ident',
          ident: { id: 'charon_ident', text: 'CHARON BARGE: DESTINATION UNRESOLVED.' },
        },
      ],
      lines: [
        ...
        { id: 'local_obelisk_04', sourceId: 'resonance_obelisk', text: "The dark companion answers in your hull's own band." },
        { id: 'local_obelisk_05', sourceId: 'resonance_obelisk', text: 'It learned your transponder the first time you looked. It is still answering.' },
        { id: 'local_cathedral_01', sourceId: 'wreck_cathedral', text: 'Nine held hours still answer on this band.' },
        { id: 'local_cathedral_02', sourceId: 'wreck_cathedral', text: 'The Marker survived the hull. It is still marking.' },
        { id: 'local_cathedral_03', sourceId: 'wreck_cathedral', text: 'Scavenger chatter thins every time the bow comes into line.' },
        { id: 'local_cathedral_04', sourceId: 'wreck_cathedral', text: 'Concord claims the bow. The static claims the rest.' },
        { id: 'local_candle_01', sourceId: 'candle_fleet', text: 'Twenty-four carriers answer. The twenty-fifth stays dark.' },
        { id: 'local_candle_02', sourceId: 'candle_fleet', text: 'Every damaged candle returns to the ledger. The band keeps the count.' },
        { id: 'local_candle_03', sourceId: 'candle_fleet', text: 'Families paid for the flames. The flames pay nobody back.' },
        { id: 'local_candle_04', sourceId: 'candle_fleet', text: 'The dark plinth answers last. It answers nothing.' },
        { id: 'local_charon_01', sourceId: 'lung_of_charon', text: 'A colony barge still breathes on the old manifest channel.' },
        { id: 'local_charon_02', sourceId: 'lung_of_charon', text: 'GARDEN WORLD: the band repeats a destination with no match.' },
        { id: 'local_charon_03', sourceId: 'lung_of_charon', text: 'The birth records answer three generations late.' },
        { id: 'local_charon_04', sourceId: 'lung_of_charon', text: 'Air and seed still trade here. Pride does not.' },
      ],
    },
  ],
});
