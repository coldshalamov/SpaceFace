...
const CORE_SECTOR_ZONES = {
  ...
  sector_helios_prime: [
    ...
    { id: 'zone_helios_lagrange', name: 'Lagrange Crucible', type: 'patrol_corridor', factionId: 'faction_scn',
      reason: 'Coalition gravitic range: two pylons hold the midpoint while the controlled pull throws along its axis.',
      center: { x: -500, z: 800 }, radius: 540, threat: 0 },
  ...
  sector_ceres_belt: [
    ...
    { id: 'zone_ceres_sluice_approach', name: 'Cinder Sluice Approach', type: 'refinery_approach', factionId: 'faction_dmc',
      reason: 'A marked, low-risk approach through the Cinder exchange flow, where crews test current timing before working the sluice.',
      center: { x: -300, z: 200 }, radius: 540 },
