...
export const COMMODITIES = [
  ...
  { id: 'cmdty_ore_bronzium',       name: 'Bronzium Ore',          category: 'raw ore',   basePrice: 60,  volatility: 0.22, elasticity: 0.40, legality: 'legal',      volPerU: 1.0, massPerU: 0.9, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['refinery','trade_hub','fab'] },
  { id: 'cmdty_ore_silverium',      name: 'Silverium Ore',         category: 'raw ore',   basePrice: 100, volatility: 0.25, elasticity: 0.45, legality: 'legal',      volPerU: 1.0, massPerU: 0.7, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['refinery','trade_hub'] },
  { id: 'cmdty_ore_goldium',        name: 'Goldium Ore',           category: 'raw ore',   basePrice: 250, volatility: 0.28, elasticity: 0.50, legality: 'legal',      volPerU: 1.0, massPerU: 1.1, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['refinery','trade_hub'] },
  { id: 'cmdty_ore_platinium',      name: 'Platinium Ore',         category: 'raw ore',   basePrice: 750, volatility: 0.30, elasticity: 0.52, legality: 'legal',      volPerU: 1.0, massPerU: 1.4, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['refinery','trade_hub'] },
  { id: 'cmdty_ore_einsteinium',    name: 'Einsteinium Ore',       category: 'raw ore',   basePrice: 2000, volatility: 0.35, elasticity: 0.55, legality: 'legal',     volPerU: 1.0, massPerU: 1.5, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['refinery','trade_hub'] },
  ...
  { id: 'cmdty_exotic_amazonite',   name: 'Amazonite Crystal',     category: 'raw ore',   basePrice: 500000, volatility: 0.60, elasticity: 0.80, legality: 'legal',   volPerU: 0.8, massPerU: 0.8, fineMult: 0,   producedBy: ['mining'],                         consumedBy: ['trade_hub','research'] },
