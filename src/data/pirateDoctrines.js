...
const DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    disguised: true,
    firstFire: true,
    firstFireAgainst: Object.freeze(['faction_mts', 'faction_dmc', 'faction_free', 'faction_scn']),
    factionPresenceDoctrine: Object.freeze({
      pursuitCommitment: 0.85,
      preferredRange: 280,
      liveFormation: 'wedge',
      retreatHullFraction: 0.28,
      combatDoctrineId: 'interceptor_flyby',
      disableThenRun: false,
      firstFire: true,
      firstFireAgainst: Object.freeze(['faction_mts', 'faction_dmc', 'faction_free', 'faction_scn']),
      firstFireCondition: null,
      stationDefenseAggression: 0.80,
      disableChance: 0.20,
      destroyTarget: true,
      fixedRoute: false,
    }),
  ...
  Object.freeze({
    ...
    firstFireAgainst: Object.freeze([]),
    factionPresenceDoctrine: Object.freeze({
      pursuitCommitment: 0.50,
      preferredRange: 380,
      liveFormation: 'line',
      retreatHullFraction: 0.45,
      combatDoctrineId: 'ranged_disengager',
      disableThenRun: false,
      firstFire: false,
      firstFireAgainst: Object.freeze([]),
      firstFireCondition: null,
      stationDefenseAggression: 0.50,
      disableChance: 0.40,
      destroyTarget: false,
      fixedRoute: false,
    }),
  ...
  Object.freeze({
    ...
    parleyMode: 'ransom',
    firstFire: true,
    firstFireAgainst: Object.freeze(['faction_mts', 'faction_dmc', 'faction_scn', 'faction_free']),
    factionPresenceDoctrine: Object.freeze({
      pursuitCommitment: 0.70,
      preferredRange: 340,
      liveFormation: 'line',
      retreatHullFraction: 0.40,
      combatDoctrineId: 'tether_control_raider',
      disableThenRun: false,
      firstFire: true,
      firstFireAgainst: Object.freeze(['faction_mts', 'faction_dmc', 'faction_scn', 'faction_free']),
      firstFireCondition: null,
      stationDefenseAggression: 0.70,
      disableChance: 0.60,
      destroyTarget: true,
      fixedRoute: false,
    }),
  ...
  Object.freeze({
    ...
    parleyMode: 'attack',
    firstFire: true,
    firstFireAgainst: Object.freeze(['faction_scn']),
    factionPresenceDoctrine: Object.freeze({
      pursuitCommitment: 0.90,
      preferredRange: 260,
      liveFormation: 'wedge',
      retreatHullFraction: 0.20,
      combatDoctrineId: 'interceptor_flyby',
      disableThenRun: false,
      firstFire: true,
      firstFireAgainst: Object.freeze(['faction_scn']),
      firstFireCondition: null,
      stationDefenseAggression: 0.85,
      disableChance: 0.10,
      destroyTarget: true,
      fixedRoute: false,
    }),
...
const REACH_CULTURE_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    factionPresenceDoctrine: Object.freeze({
      ...
      disableThenRun: false,
      firstFire: false,
      firstFireAgainst: Object.freeze(['faction_mts', 'faction_dmc', 'faction_free']),
      firstFireCondition: null,
