...
const RAW_UNIQUE_WRECKS = [
  ...
  wreck({
    ...
    uniqueDrops: [
      { id: 'unique_pale_coil_warp_drive', kind: 'module', baseId: 'mod_engine_warp_l' },
      { id: 'mod_overcharge_coil_forbidden', kind: 'module', baseId: 'mod_field_amplifier_m' },
    ],
  ...
  wreck({
    ...
    uniqueDrops: [
      ...
      { id: 'mod_mass_faker_forbidden', kind: 'module', baseId: 'mod_decoy_launcher_s' },
    ],
  ...
  wreck({
    ...
    uniqueDrops: [
      { id: 'unique_knitbots', kind: 'module', baseId: 'mod_repair_nanobots_m' },
      { id: 'mod_deadman_reactor_forbidden', kind: 'module', baseId: 'mod_repair_nanobots_m' },
    ],
