...
export const ENEMY_TYPES = [
  ...
  },
  {
    ...
    heavyFightShape: {
      capability: 'carrier_screen', counterVerb: 'destroy_launch_bays_before_the_screen_grows',
      tell: 'paired_hangar_slots_and_launch_flashes', runtime: 'physical_parts_v1',
    },
    behavior: 'paired physical launch bays release one bounded five-craft mote/wasp screen',
  ...
  },
  {
    ...
    weapons: [
      { id: 'wpn_beam_laser_m', rangeOverride: 300 },
      { id: 'wpn_beam_laser_m', rangeOverride: 300 },
    ],
    ...
    heavyFightShape: {
      capability: 'industrial_foundry', counterVerb: 'detonate_or_repulse_the_ore_then_strip_the_rack',
      tell: 'industrial_spine_drill_head_and_yellow_hazard_zones', runtime: 'physical_parts_v1',
    },
    behavior: 'close-range twin industrial cutters pressure a bounded physical charged-ore mine line',
    counterHint: 'detonate_or_repulse_the_ore_then_strip_the_rack',
