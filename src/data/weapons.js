...
export const WEAPONS = [
  ...
  },
  {
    ...
    hullPresentation: { signature: 'ironsong_rotary', recognition: 'exposed twin drums and ribbed long barrel' },
  ...
  },
  {
    ...
    purchasable: false, unique: true, salvageOnly: true,
    hullPresentation: { signature: 'veil_focusing_cage', recognition: 'open three-prong focusing cage' },
  ...
  },
  {
    ...
    purchasable: false, unique: true, salvageOnly: true,
    hullPresentation: { signature: 'nestbreaker_split_rack', recognition: 'paired split launch racks' },
  ...
  },
  {
    ...
    purchasable: false, unique: true, salvageOnly: true,
    hullPresentation: { signature: 'lighthouse_ring_spine', recognition: 'ringed beam spine and beacon lens' },
