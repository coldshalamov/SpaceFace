...
test('the instrument measures the real path around a 100 WU line at 1.5x cruise', LONG, async () => {
  ...
  assert.equal(m.barMet, true,
    'Swinging at 1.5× cruise on a 100 WU line around a heavy anchor stretches the line < 10 % and does not break; releasing at the tangent keeps ≥ 95 % of tangential speed 5 s later. — "Swing around a huge asteroid and let go flying."');
